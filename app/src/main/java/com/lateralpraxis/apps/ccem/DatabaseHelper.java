...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase _db) {
        ...
        _db.execSQL(DatabaseAdapter.LossAssessmentFormSearchTemp_Create);
        ...
        _db.execSQL(DatabaseAdapter.InsuredCropVerificationFormTemp_Create);
        _db.execSQL(DatabaseAdapter.InsuredCropVerificationForm_Create);
        _db.execSQL(DatabaseAdapter.InsuredCropVerificationFormSearchTemp_Create);
        _db.execSQL(DatabaseAdapter.NEWCCEFormTemp_Create);
        _db.execSQL(DatabaseAdapter.NEWCCEForm_Create);
        _db.execSQL(DatabaseAdapter.NewCCEFormTempDocument_Create);
    }

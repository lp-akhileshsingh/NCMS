...
public class ActivityLASecond extends AppCompatActivity {

    private Common common;
    private DatabaseAdapter dba;
    private ArrayList<String> laformdetails, laformtempdetails;
    private String searchId, fromPage, stageOfLossId = "0", causeOfLossId = "0", uniqueId, farmerMobileNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_la_second);
        ...
        if (extras != null) {
            ...
            etKhasraSurveyNo.setText(laformdetails.get(23));
            //tvSowingDate.setText(laformdetails.get(20));
            tvLossDate.setText(common.convertToDisplayDateFormat(laformdetails.get(24)));
            tvLossIntimationDate.setText(common.convertToDisplayDateFormat(laformdetails.get(25)));
            dba.open();
            dba.InsertLossAssessmentCauseofLossTemp(uniqueId, laformdetails.get(26));
            dba.close();
            farmerMobileNo = laformdetails.get(19);
            dba.openR();
            spStageOfLoss.setAdapter(DataAdapter("lossstage", "",""));

            dba.openR();
            if (dba.isTemporaryLADataAvailable()) {   // If data is present in Temporary Table then get all the values
                dba.openR();
                laformtempdetails = dba.getLAFormTempDetails();
                if(laformtempdetails.get(19)!=null)
                    etKhasraSurveyNo.setText(laformtempdetails.get(19));
                tvSowingDate.setText(laformtempdetails.get(20));
                stageOfLossId = laformtempdetails.get(23);
                etLossPercentage.setText(laformtempdetails.get(24));
                etGovtOfficerName.setText(laformtempdetails.get(25));
                etGovtOfficerDesignation.setText(laformtempdetails.get(26));
                etGovtOfficerContact.setText(laformtempdetails.get(27));
                etComment.setText(laformtempdetails.get(28));
                farmerMobileNo = laformtempdetails.get(10);
                etApproxArea.setText(laformtempdetails.get(37));
                etPremium.setText(laformtempdetails.get(38));
            ...
            // To load the Cause of Loss Dropdown
            BindLossCauseData();
        }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(etKhasraSurveyNo.getText().toString().trim())) {
                    ...
                    etLossPercentage.requestFocus();
                } /*else if (Double.valueOf(etLossPercentage.getText().toString().trim())== 0 )
                {
                    ...
                    Intent intent = new Intent(ActivityLASecond.this, ActivityLossAssessmentThirdSummary.class);
        ...
        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ActivityLASecond.this, ActivityLossAssessmentFinal.class);
                intent.putExtra("From", "SecondSearch");
                intent.putExtra("uniqueId", uniqueId);
                startActivity(intent);
                finish();
            }
    ...
    private void BindLossCauseData() {
        ...
        if (lsize == 0) {
            ...
            lvCauseOfLoss.setAdapter(new ListAdapter(ActivityLASecond.this, HeaderDetails));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                intent = new Intent(ActivityLASecond.this, ActivityHomeScreen.class);
                startActivity(intent);
                finish();
                return true;
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                Intent homeScreenIntent = new Intent
                                        (ActivityLASecond.this, ActivityHomeScreen.class);
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ActivityLASecond.this);
        ...
        builder1.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog,
                                        int id) {
                        Intent homeScreenIntent = new Intent(ActivityLASecond.this, ActivityLAFirst.class);

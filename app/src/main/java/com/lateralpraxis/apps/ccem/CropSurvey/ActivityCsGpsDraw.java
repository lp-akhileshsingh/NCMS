...
public class ActivityCsGpsDraw extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnPolylineClickListener, GoogleMap.OnPolygonClickListener, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dba.open();
        dba.DeleteCropSurveyTempGeoTagByType("Walk");
        dba.close();
        ...
        removeAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ActivityCsGpsDraw.this);
                // set title
        ...
        btnFetchGps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                longitudeN = "NA";
                // create class object
                gps = new GPSTracker(ActivityCsGpsDraw.this);
                ...
                if (gps.canGetLocation()) {
                    if (gps.isFromMockLocation()) {
                        ...
                        if (flatitude == 0.0 || flongitude == 0.0) {
                            common.showAlert(ActivityCsGpsDraw.this, "Unable to fetch coordinates. Please try again.", false);
                        } else {
                            ...
                            if (!latitude.equals("NA") && !longitude.equals("NA")) {
                                ...
                                mapFragment.getMapAsync(ActivityCsGpsDraw.this);
        ...
        btnAddGps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (arrayPoints.size() >= 4) {
                    for (i = 0; i < arrayPoints.size(); i++) {
                        dba.open();
                        Boolean isGPSExists = dba.CropSurveyTempGeoTagExists(String.valueOf(String.format("%.6f", arrayPoints.get(i).latitude)), String.valueOf(String.format("%.6f", arrayPoints.get(i).longitude)));
                        if (isGPSExists.equals(true)) {
                            duplicateCount =duplicateCount+1;
                        }
                    }
                    if(duplicateCount>0) {
                        common.showAlert(ActivityCsGpsDraw.this, "This coordinate is already captured.", false);
                    }
                    else
                    {
                        dba.open();
                        ...
                        for (i = 0; i < arrayPoints.size(); i++) {
                            dba.open();
                            dba.Insert_CropSurveyTempGeoTag(String.valueOf(String.format("%.6f", arrayPoints.get(i).latitude)), String.valueOf(String.format("%.6f", arrayPoints.get(i).longitude)), "NA","Draw");
                            dba.close();
                        }
                        common.showAlert(ActivityCsGpsDraw.this, "Coordinate saved successfully.", false);
                    ...
                    common.showToast("Draw minimum 4 coordinates!", 5, 1);
            }
        });
            ...
            public void onClick(View arg0) {
                if (btnNext.getText().toString().equalsIgnoreCase("Skip")) {
                    ...
                    alertDialogBuilder.setMessage("Are you sure, you want to skip capturing coordinates?")
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    intent = new Intent(ActivityCsGpsDraw.this, ActivityCreateCS1.class);
    ...
    //<editor-fold desc="Method to bind list view">
    ...
    public void onMapReady(GoogleMap googleMap) {
        if (!latitude.equals("NA") && !longitude.equals("NA")) {
            ...
            googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(Double.valueOf(latitude), Double.valueOf(longitude)), 18.0f));
    ...
    public void onMapClick(LatLng point) {
        if (checkClick == false) {
            ngoogleMap.addMarker(new MarkerOptions().position(point).icon(
    ...
    public void countPolygonPoints() {
        if (arrayPoints.size() >= 4) {
            ...
            Polygon polygon = ngoogleMap.addPolygon(polygonOptions);
        }
    }
                ...
                builder1.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                                int id) {
                                Intent intent = new Intent(ActivityCsGpsDraw.this, ActivityCreateCS1.class);
                                intent.putExtra("uniqueId", uniqueId);
            ...
            case R.id.action_go_home:
                ...
                builderhome.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                                int id) {
                                Intent homeScreenIntent = new Intent(ActivityCsGpsDraw.this, ActivityHomeScreen.class);
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(ActivityCsGpsDraw.this);
        builder1.setTitle("Confirmation");
        ...
        builder1.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog,
                                        int id) {
                        Intent homeScreenIntent = new Intent(ActivityCsGpsDraw.this, ActivityCreateCS1.class);

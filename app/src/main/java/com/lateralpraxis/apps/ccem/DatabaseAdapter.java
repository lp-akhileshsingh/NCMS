...
public class DatabaseAdapter {
    ...
    static final String DATABASE_NAME = "CCEMLATEST.db";
    static final int DATABASE_VERSION = 5;
    // Crating tables of database
    static final String Exceptions_CREATE = "CREATE TABLE IF NOT EXISTS Exceptions(Id INTEGER PRIMARY KEY AUTOINCREMENT, Message TEXT, ActivityName TEXT, CalledMethod TEXT, PhoneInfo TEXT, CreatedOn DATETIME);",
            EmployeeType_CREATE = "CREATE TABLE IF NOT EXISTS EmployeeType(Id TEXT, Name TEXT);",
            TempDocTABLE_CREATE = "CREATE TABLE IF NOT EXISTS TempDoc (FileName TEXT, Type TEXT);",
            KYCDocument_CREATE = "CREATE TABLE IF NOT EXISTS KYCDocument(Id TEXT, Name TEXT);",
            SupervisorForms_Create = "CREATE TABLE IF NOT EXISTS SurveyorForms(Id INTEGER PRIMARY KEY AUTOINCREMENT, SurveyorId TEXT, FormId TEXT, FormName TEXT)",
            SurveyorBlockFormAssignment_Create = "CREATE TABLE IF NOT EXISTS SurveyorBlockFormAssignment(SurveyFormId TEXT,StateId TEXT,DistrictId TEXT,BlockId TEXT)",
            State_Create = "CREATE TABLE IF NOT EXISTS State(StateId TEXT, StateName TEXT)",
            District_Create = "CREATE TABLE IF NOT EXISTS District(StateId TEXT, DistrictId TEXT, DistrictName TEXT)",
            Block_Create = "CREATE TABLE IF NOT EXISTS Block(DistrictId TEXT, BlockId TEXT, BlockName TEXT)",
            Panchayat_Create = "CREATE TABLE IF NOT EXISTS Panchayat(RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT)",
            Village_Create = "CREATE TABLE IF NOT EXISTS Village(PanchayatId TEXT, VillageId TEXT, VillageName TEXT)",
            Crop_Create = "CREATE TABLE IF NOT EXISTS Crop(CropId TEXT, CropName TEXT, IsMultiPicking TEXT)",
            CropVariety_Create = "CREATE TABLE IF NOT EXISTS CropVariety(CropId TEXT,CropVarietyId TEXT, CropVarietyName TEXT)",
            CropStage_Create = "CREATE TABLE IF NOT EXISTS CropStage(CropStageId TEXT, CropStageName TEXT)",
            Season_Create = "CREATE TABLE IF NOT EXISTS SeasonMaster (Id TEXT,Season TEXT, Year REAL, FromMonth REAL, FromYear REAL, ToMonth REAL, ToYear REAL);",
            RevenueCircle_Create = "CREATE TABLE IF NOT EXISTS RevenueCircle(BlockId TEXT, RevenueCircleId TEXT, RevenueCircleName TEXT)",
            PlotSize_Create = "CREATE TABLE IF NOT EXISTS PlotSize(PlotSizeId TEXT, PlotSizeName TEXT)",
            Property_Create = "CREATE TABLE IF NOT EXISTS Property(PropertyId TEXT, PropertyName TEXT)",
            LossStage_Create = "CREATE TABLE IF NOT EXISTS LossStage(LossStageId TEXT, LossStageName TEXT)",
            LossCause_Create = "CREATE TABLE IF NOT EXISTS LossCause(LossCauseId TEXT, LossCauseName TEXT)",
            IrrigationSource_Create = "CREATE TABLE IF NOT EXISTS IrrigationSource(IrrigationSourceId TEXT, IrrigationSourceName TEXT)",
            LeafCondition_Create = "CREATE TABLE IF NOT EXISTS LeafCondition(LeafConditionId TEXT, LeafConditionName TEXT)",
            StateWiseGPSAccuracy_Create = "CREATE TABLE IF NOT EXISTS StateWiseGPSAccuracy(StateId TEXT, Accuracy TEXT)",
            SurveyFormPictureUpload_Create = "CREATE TABLE IF NOT EXISTS SurveyFormPictureUpload(SurveyFormId TEXT, Id TEXT, Name TEXT, MaxLimit TEXT, IsGallery TEXT, IsCamera TEXT, Type TEXT)",
            WeightType_Create = "CREATE TABLE IF NOT EXISTS WeightType(WeightTypeId TEXT, WeightTypeName TEXT)",

    RoadSideCrowdSourcing_Create = "CREATE TABLE IF NOT EXISTS RoadSideCrowdSourcing(Id INTEGER PRIMARY KEY AUTOINCREMENT, UniqueId TEXT, SurveyDate TEXT, StateId TEXT, State TEXT, DistrictId TEXT, District TEXT, BlockId TEXT, Block TEXT, Village TEXT, GPSBasedSurvey TEXT, LeftSideCropId TEXT, LeftSideCrop TEXT, LeftSideCropStageId TEXT, LeftSideCropStage TEXT, LeftSideCropCondition TEXT, RightSideCropId TEXT, RightSideCrop TEXT, RightSideCropStageId TEXT, RightSideCropStage TEXT, RightSideCropCondition TEXT, CropId TEXT, Crop TEXT, CropStageId TEXT, CropStage TEXT, CurrentCropCondition TEXT, LatitudeInside TEXT, LongitudeInside TEXT, AccuracyInside TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, CreateBy TEXT, CreateDate TEXT, IsSync TEXT, IsTemp TEXT)",

    LandUnit_CREATE = "CREATE TABLE IF NOT EXISTS LandUnit(Id TEXT, Name TEXT);",
            AreaComparison_CREATE = "CREATE TABLE IF NOT EXISTS AreaComparison(Id TEXT, Name TEXT);",
            CropPattern_CREATE = "CREATE TABLE IF NOT EXISTS CropPattern(Id TEXT, Name TEXT);",
            CropCondition_CREATE = "CREATE TABLE IF NOT EXISTS CropCondition(Id TEXT, Name TEXT);",
            WeightUnit_CREATE = "CREATE TABLE IF NOT EXISTS WeightUnit(Id TEXT, Name TEXT);",
            CropSurveyTempFile_CREATE = "CREATE TABLE IF NOT EXISTS CropSurveyTempFile(UniqueId TEXT, Type TEXT, FileName TEXT)",
            CropSurveyTempGeoTag_Create = "CREATE TABLE IF NOT EXISTS CropSurveyTempGeoTag(Id INTEGER PRIMARY KEY, Latitude TEXT, Longitude TEXT, Accuracy TEXT, PolygonType TEXT)",
            CropSurveyGeoTag_Create = "CREATE TABLE IF NOT EXISTS CropSurveyGeoTag(Id INTEGER PRIMARY KEY, MasterUniqueId TEXT, EntityId TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, CreateBy TEXT, CreateDate TEXT, IsSync TEXT, IsTemp TEXT)",
            CropSurvey_Create = "CREATE TABLE IF NOT EXISTS CropSurvey(Id INTEGER PRIMARY KEY AUTOINCREMENT, UniqueId TEXT, SeasonId TEXT, Season TEXT, StateId TEXT, State TEXT, DistrictId TEXT, District TEXT, BlockId TEXT, Block TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, CropId TEXT, Crop TEXT, CropVarietyId TEXT, CropVariety TEXT, VarietyName TEXT, CropDuration TEXT, CropDurationDay TEXT, ApproxCropArea TEXT, ContigeousCropArea TEXT, Irrigation TEXT, IrrigationSourceId TEXT, IrrigationSource TEXT, SowingDate TEXT, HarvestDate TEXT, CropStageId TEXT, CropStage TEXT, CropAge TEXT, CropHealth TEXT, PlantDensity TEXT, Weeds TEXT, IsDamagedByPest TEXT, AverageYield TEXT, ExpectedYield TEXT, Comments TEXT, LatitudeInside TEXT, LongitudeInside TEXT, AccuracyInside TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, CreateBy TEXT, CreateDate TEXT, IsSync TEXT, IsTemp TEXT, IsFarmerAvailable TEXT, CropLandUnitId TEXT, CropLandUnit TEXT, CropAreaCurrent TEXT, CropAreaPast TEXT, ExtentAreaPastId TEXT, ExtentAreaPast TEXT, ReasonReplacedBy TEXT, CropPatternId TEXT, CropPattern TEXT, CropConditionId TEXT, CropCondition TEXT, DamageType TEXT, DamageFileName TEXT, WeightUnitId TEXT, WeightUnit TEXT, LandUnitId TEXT, LandUnit TEXT, GPSType TEXT,  GPSPolygonType TEXT, DamageFilePath TEXT,PlotSizeId TEXT,PlotSize TEXT, PlantCount TEXT, PlantHeightInFeet TEXT, BranchCount TEXT, SquareCount TEXT, FlowerCount TEXT, BallCount TEXT, ExpectedFirstPickingDate TEXT,CompanySeed TEXT)",
            ServiceProvider_Create = "CREATE TABLE IF NOT EXISTS ServiceProvider(Id TEXT, Title TEXT)",
            SiteSurvey_Create = "CREATE TABLE IF NOT EXISTS SiteSurvey(Id INTEGER PRIMARY KEY AUTOINCREMENT, UniqueId TEXT, SeasonId TEXT, Season TEXT, StateId TEXT, State TEXT, DistrictId TEXT, District TEXT, BlockId TEXT, Block TEXT, RevenueCircleId TEXT, RevenueCircle TEXT, PanchayatId TEXT, Panchayat TEXT, OtherPanchayat TEXT, VillageId TEXT, Village TEXT, OtherVillage TEXT, SurveyDate TEXT, PropertyId TEXT, Property TEXT, IsObstacles TEXT, IsEarthquake TEXT, IsBigTrees TEXT, IsLargeWater TEXT, IsHighTension TEXT, IsPowerCable TEXT, ServiceProviderId TEXT, ServiceProvider TEXT, IsProposed TEXT, IsRecommended TEXT, Comments TEXT, SiteLatitude TEXT, SiteLongitude TEXT, SiteAccuracy TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, CreateBy TEXT, CreateDate TEXT, IsSync TEXT, IsTemp TEXT)",
            CCEMFormTemp_Create = "CREATE TABLE IF NOT EXISTS CCEMFormTemp(AndroidUniqueId TEXT,SeasonId TEXT, RandomNo TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, OfficerName TEXT, OfficerDesignation TEXT, OfficerContactNo TEXT, CropId TEXT, CropVarietyId TEXT, Irrigation TEXT, SowingArea TEXT, HighestKhasraSurveyNo TEXT, CCEPlotKhasraSurveyNo TEXT,  IsFieldIndetified TEXT, FarmerType TEXT, CropCondition TEXT, IsDamagedByPest TEXT, IsMixedCrop TEXT, CropName TEXT, IsAppUsedByGovtOfficer TEXT, IsGovtRequisiteEquipmentAvailable TEXT, IsCCEProcedureFollowed TEXT, SWCLongitude TEXT, SWCLatitude TEXT, SWCAccuracy TEXT, PlotSizeId TEXT, WeightTypeId TEXT, ExperimentWeight  TEXT, IsDriageDone  TEXT, IsForm2FIlled TEXT, IsCopyOfForm2Collected TEXT, IsWIttnessFormFilled TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT,  AndroidCreateDate TEXT)",
            CCEMFormTempDocument_Create = "CREATE TABLE IF NOT EXISTS CCEMFormTempDocument(UniqueId TEXT, FormType TEXT, FormUniqueId TEXT, PictureUploadId TEXT, FileName TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, AttachmentDate TEXT,CreateBy TEXT)",
            CCEMForm_Create = "CREATE TABLE IF NOT EXISTS CCEMForm(AndroidUniqueId TEXT,SeasonId TEXT, RandomNo TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, OfficerName TEXT, OfficerDesignation TEXT, OfficerContactNo TEXT, CropId TEXT, CropVarietyId TEXT, Irrigation TEXT, SowingArea TEXT, HighestKhasraSurveyNo TEXT, CCEPlotKhasraSurveyNo TEXT,  IsFieldIndetified TEXT, FarmerType TEXT, CropCondition TEXT, IsDamagedByPest TEXT, IsMixedCrop TEXT, CropName TEXT, IsAppUsedByGovtOfficer TEXT, IsGovtRequisiteEquipmentAvailable TEXT, IsCCEProcedureFollowed TEXT, SWCLongitude TEXT, SWCLatitude TEXT, SWCAccuracy TEXT, PlotSizeId TEXT, WeightTypeId TEXT, ExperimentWeight  TEXT, IsDriageDone  TEXT, IsForm2FIlled TEXT, IsCopyOfForm2Collected TEXT, IsWIttnessFormFilled TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT,  AndroidCreateDate TEXT, IsSync TEXT)",
            CCEMFormDocument_Create = "CREATE TABLE IF NOT EXISTS CCEMFormDocument(UniqueId TEXT, FormType TEXT, FormUniqueId TEXT, PictureUploadId TEXT, FileName TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, AttachmentDate TEXT,CreateBy TEXT, IsSync TEXT)",
            TempFile_CREATE = "CREATE TABLE IF NOT EXISTS TempFile(Type TEXT, FileName TEXT)",
            TempVideo_CREATE = "CREATE TABLE IF NOT EXISTS TempVideo(Type TEXT, FileName TEXT)",
            CCEMFormTempStatus_Create = "CREATE TABLE IF NOT EXISTS CCEMFormTempStatus(AndroidUniqueId TEXT,FirstFromStatus TEXT, SecondFormStatus TEXT, ThirdFormStatus TEXT)",
            Driage_Create = "CREATE TABLE Driage(CCEMSurveyFormId TEXT, OfficerName TEXT, SurveyDate TEXT, CropName TEXT, RandomNo TEXT, CCEPlotKhasraSurveyNo TEXT, ExperimentWeight TEXT, SeasonId TEXT, IsMultipleDriage TEXT, StateId TEXT)",
            DriageFormTemp_Create = "CREATE TABLE IF NOT EXISTS DriageFormTemp(AndroidUniqueId TEXT, SeasonId TEXT, CCEMSurveyFormId TEXT, WeightInKg  TEXT, IsForm2FIlled TEXT, IsCopyOfForm2Collected TEXT, IsWIttnessFormFilled TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT,  AndroidCreateDate TEXT, IsSubmit TEXT)",
            DriageFormTempDocument_Create = "CREATE TABLE IF NOT EXISTS DriageFormTempDocument(UniqueId TEXT, FormType TEXT, FormUniqueId TEXT, PictureUploadId TEXT, FileName TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, AttachmentDate TEXT,CreateBy TEXT)",
            DriageForm_Create = "CREATE TABLE IF NOT EXISTS DriageForm(AndroidUniqueId TEXT, SeasonId TEXT, CCEMSurveyFormId TEXT, WeightInKg  TEXT, IsForm2FIlled TEXT, IsCopyOfForm2Collected TEXT, IsWIttnessFormFilled TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT,  AndroidCreateDate TEXT, IsSync TEXT)",
            Form2COllectionTemp_Create = "CREATE TABLE IF NOT EXISTS Form2CollectionTemp(AndroidUniqueId TEXT, CCEMSurveyFormId TEXT, SeasonId TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, OfficerName TEXT, OfficerDesignation TEXT, OfficerContactNo TEXT, CropId TEXT, RandomNo TEXT, HighestKhasraSurveyNo TEXT, CCEPlotKhasraSurveyNo TEXT, PlotSizeId TEXT, WetWeight TEXT, DryWeight TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, AndroidCreateDate TEXT)",
            Form2Collection_Create = "CREATE TABLE IF NOT EXISTS Form2Collection(AndroidUniqueId TEXT, CCEMSurveyFormId TEXT, SeasonId TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, OfficerName TEXT, OfficerDesignation TEXT, OfficerContactNo TEXT, CropId TEXT, RandomNo TEXT, HighestKhasraSurveyNo TEXT, CCEPlotKhasraSurveyNo TEXT, PlotSizeId TEXT, WetWeight TEXT, DryWeight TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, AndroidCreateDate TEXT)",
            CCEMSurveyApprovedForm_Create = "CREATE TABLE IF NOT EXISTS CCEMSurveyApprovedForm(CCEMFormId TEXT, SeasonId TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, OfficerName TEXT, OfficerDesignation TEXT, OfficerContactNo TEXT, CropId TEXT, RandomNo TEXT, HighestKhasraSurveyNo TEXT, CCEPlotKhasraSurveyNo TEXT, PlotSizeId TEXT, ExperimentWeight TEXT)",
            CropMonitoringTemp_Create = "CREATE TABLE IF NOT EXISTS CropMonitoringTemp(AndroidUniqueId TEXT, SeasonId TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, CropId TEXT, ExpectedHarvestDate TEXT, CropStageId TEXT, CropAge TEXT, CropHealth TEXT, PlantDensity TEXT, Weeds  TEXT,IsDamagedByPest TEXT,AverageYield TEXT,ExpectedYield TEXT,Comments TEXT, LatitudeInsideField  TEXT,LongitudeInsideField TEXT, AccuracyInsideField TEXT,Latitude TEXT, Longitude TEXT, Accuracy TEXT,AndroidCreateDate TEXT)",
            CropMonitoring_Create = "CREATE TABLE IF NOT EXISTS CropMonitoring(AndroidUniqueId TEXT, SeasonId TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, CropId TEXT, ExpectedHarvestDate TEXT, CropStageId TEXT, CropAge TEXT, CropHealth TEXT, PlantDensity TEXT,Weeds  TEXT,IsDamagedByPest TEXT,AverageYield TEXT,ExpectedYield TEXT,Comments TEXT, LatitudeInsideField  TEXT,LongitudeInsideField TEXT, AccuracyInsideField TEXT,Latitude TEXT, Longitude TEXT, Accuracy TEXT,AndroidCreateDate TEXT, IsSync TEXT)",
    // Start Section of Create Tables of Loss Assessment
    Ownership_Create = "CREATE TABLE IF NOT EXISTS OwnershipType(OwnershipId TEXT, OwnershipName TEXT)",
            LossAssFormTemp_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentTemp(AndroidUniqueId TEXT, SeasonId TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, FarmerType TEXT, OwnershipTypeId TEXT, CropId TEXT, SowingArea TEXT, KhasraSurveyNo TEXT, DateOfSowing TEXT, DateofLoss TEXT, DateOfLossIntimation TEXT, StageOfLossId TEXT, LossPercentage TEXT, OfficerName TEXT, OfficerDesignation TEXT, OfficerContactNo TEXT, Comments TEXT, AfLongitude TEXT, AfLatitude TEXT, AfAccuracy TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT,  AndroidCreateDate TEXT, FatherName TEXT, InsuredArea TEXT, ApproxArea TEXT, PremiumAmount TEXT, ClaimIntimationNo TEXT, ApplicationNumber TEXT, SearchId TEXT)",
            LossAssForm_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentForm(AndroidUniqueId TEXT, SeasonId TEXT, StateId TEXT, DistrictId TEXT, BlockId TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, SurveyDate TEXT, FarmerType TEXT, OwnershipTypeId TEXT, CropId TEXT, SowingArea TEXT, KhasraSurveyNo TEXT, DateOfSowing TEXT, DateofLoss TEXT, DateOfLossIntimation TEXT, StageOfLossId TEXT, LossPercentage TEXT, OfficerName TEXT, OfficerDesignation TEXT, OfficerContactNo TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT,  AndroidCreateDate TEXT, IsSync TEXT, FatherName TEXT, InsuredArea TEXT, ApproxArea TEXT, PremiumAmount TEXT, ClaimIntimationNo TEXT, ApplicationNumber TEXT, SearchId TEXT)",
            LossAssCOLTemp_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentCOLTemp(LossAssessmentUniqueId TEXT, CauseOfLossId TEXT)",
            LossAssCOL_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentCOL(LossAssessmentUniqueId TEXT, CauseOfLossId TEXT)",
            LossAssessmentGeoTag_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentGeoTag(Id INTEGER PRIMARY KEY, LossAssessmentUniqueId TEXT, EntityId TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, CreateBy TEXT, CreateDate TEXT, IsSync TEXT)",
            LossAssessmentTempGeoTag_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentTempGeoTag(Id INTEGER PRIMARY KEY, Latitude TEXT, Longitude TEXT,Accuracy TEXT)",
            LossAssessmentFormTempDocument_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentFormTempDocument(UniqueId TEXT, FormType TEXT, FormUniqueId TEXT, PictureUploadId TEXT, FileName TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, AttachmentDate TEXT,CreateBy TEXT)",
            LossAssessmentFormTempStatus_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentFormTempStatus(AndroidUniqueId TEXT,FirstFromStatus TEXT, SecondFormStatus TEXT, ThirdFormStatus TEXT)",
            LossAssessmentFormSearchTemp_Create = "CREATE TABLE IF NOT EXISTS LossAssessmentSearchTemp(SearchId TEXT, SeasonId TEXT, SeasonName, ApplicationNumber TEXT, ClaimIntimationNo TEXT, StateId TEXT, StateName TEXT, DistrictId TEXT, DistrictName TEXT, BlockId TEXT, BlockName TEXT, RevenueCircleId TEXT, RevenueCircle TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, FatherName TEXT, MobileNo TEXT, CropId TEXT, CropName TEXT, InsuredArea TEXT, KhasraSurveyNo TEXT, DateofLoss TEXT, DateOfLossIntimation TEXT, LossCauseId TEXT, LossCause TEXT)",
    // End Section of Create Tables of Loss Assessment
    SelectedSyncData_Create = "CREATE TABLE IF NOT EXISTS SelectedSyncData(FormId TEXT,FormName TEXT,IsSync TEXT)",
            DriageAndPicking_Create = "CREATE TABLE IF NOT EXISTS DriageAndPicking(UniqueId TEXT, SeasonId TEXT, Season TEXT, RandomNo TEXT, StateId TEXT, State TEXT, DistrictId TEXT, District TEXT, BlockId TEXT, Block TEXT, RevenueCircleId TEXT, RevenueCircle TEXT, PanchayatId TEXT, Panchayat TEXT, PanchayatName TEXT, VillageId TEXT, Village TEXT, VillageName TEXT, FarmerName TEXT, Mobile TEXT, SurveyDate TEXT, OfficerName TEXT, OfficerDesignation TEXT, OfficerContactNo TEXT, CropId TEXT, Crop TEXT, HighestKhasraSurveyNo TEXT, CCEPlotKhasraSurveyNo TEXT, SWCLongitude TEXT, SWCLatitude TEXT, SWCAccuracy TEXT, Type TEXT, PickingCount TEXT, PickingWeight TEXT, BundleWeight TEXT, DryWeight TEXT, IsForm2FIlled TEXT, IsWIttnessFormFilled TEXT, Comments TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, CreateDate TEXT, CreateBy TEXT, IsSync TEXT, IsTemp TEXT)",
            LastScanDate_Create = "CREATE TABLE IF NOT EXISTS LastScanDate(Code TEXT, Date TEXT)",
            PurposeOfVisit_Create = "CREATE TABLE IF NOT EXISTS PurposeOfVisit(Id TEXT, Title TEXT)",
            FaultyComponent_Create = "CREATE TABLE IF NOT EXISTS FaultyComponent(Id TEXT, Title TEXT)",
            FaultySensor_Create = "CREATE TABLE IF NOT EXISTS FaultySensor(Id TEXT, Title TEXT)",
            AWSMaintenanceForm_Create = "CREATE TABLE IF NOT EXISTS AWSMaintenanceForm(UniqueId TEXT, StateId TEXT, State TEXT, DistrictId TEXT, District TEXT, BlockId TEXT, Block TEXT, RevenueCircleId TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, BarCodeScan TEXT, LastScanDate TEXT, PurposeOfVisitId TEXT, PurposeOfVisit TEXT, ProblemIdentified TEXT, AnyFaultyComponent TEXT, ReasonForRelocation TEXT, IsSensorWorking TEXT, SensorName TEXT, BatteryVoltage TEXT, SolarPanelVoltage TEXT, IMEINumber TEXT, SIMNumber TEXT, ServiceProviderId TEXT, ServiceProvider TEXT, IsDataTransmitted TEXT, AWSLatitude TEXT, AWSLongitude TEXT, AWSAccuracy TEXT, PropertyId TEXT, Property TEXT, HostPaymentPaidUpto TEXT, Comments TEXT, CreateBy TEXT, CreateDate TEXT, IsSync TEXT, IsTemp TEXT, AnyFaultyComponentId TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, SensorId TEXT)",
            TraderFieldSurvey_Create = "CREATE TABLE IF NOT EXISTS TraderFieldSurvey(Id INTEGER PRIMARY KEY AUTOINCREMENT, UniqueId TEXT, SeasonId TEXT, Season TEXT, StateId TEXT, State TEXT, DistrictId TEXT, District TEXT, BlockId TEXT, Block TEXT, SurveyDate TEXT, Respondent TEXT, OtherRespondent TEXT, RespondentName TEXT, MobileNo TEXT, MonsoonOnset TEXT, RainfallPattern TEXT, RainInLast15Days TEXT, RemarksOnRainfallPattern TEXT, PrimaryCropId TEXT, PrimaryCrop TEXT, PrimaryMajorVarities TEXT, PrimaryFromSowingDate TEXT, PrimaryToSowingDate TEXT, PrimaryFromHarvestDate TEXT, PrimaryToHarvestDate TEXT, PrimaryDaysOfOldCrop TEXT, PrimaryCropStageId TEXT, PrimaryCropStage TEXT, PrimaryCropCondition TEXT, PrimaryIsPestAttack TEXT, PrimaryPestAttackType TEXT, PrimaryAverageYield TEXT, PrimaryExpectedYield TEXT, PrimaryRemarks TEXT, SecondaryCropId TEXT, SecondaryCrop TEXT, SecondaryMajorVarities TEXT, SecondaryFromSowingDate TEXT, SecondaryToSowingDate TEXT, SecondaryFromHarvestDate TEXT, SecondaryToHarvestDate TEXT, SecondaryDaysOfOldCrop TEXT, SecondaryCropStageId TEXT, SecondaryCropStage TEXT, SecondaryCropCondition TEXT, SecondaryIsPestAttack TEXT, SecondaryPestAttackType TEXT, SecondaryAverageYield TEXT, SecondaryExpectedYield TEXT, SecondaryRemarks TEXT, TertiaryCropId TEXT, TertiaryCrop TEXT, TertiaryMajorVarities TEXT, TertiaryFromSowingDate TEXT, TertiaryToSowingDate TEXT, TertiaryFromHarvestDate TEXT, TertiaryToHarvestDate TEXT, TertiaryDaysOfOldCrop TEXT, TertiaryCropStageId TEXT, TertiaryCropStage TEXT, TertiaryCropCondition TEXT, TertiaryIsPestAttack TEXT, TertiaryPestAttackType TEXT, TertiaryAverageYield TEXT, TertiaryExpectedYield TEXT, TertiaryRemarks TEXT, GPSLatitude TEXT, GPSLongitude TEXT, GPSAccuracy TEXT, IsCropRiskInBlock TEXT, CropRiskTaluka TEXT, CropRiskBlock TEXT, MultipleCropId TEXT, MultipleCrop TEXT, MultipleAbiotic TEXT, AbioticPercentage TEXT, MultipleBiotic TEXT,  BioticPercentage TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, CreateBy TEXT, CreateDate TEXT, IsSync TEXT, IsTemp TEXT, CropRiskRemarks TEXT)",
            SummaryReport_Create = "CREATE TABLE IF NOT EXISTS SummaryReport(Name TEXT,SubmitCount TEXT)",
    //AWS Installation Tables
    AWSInstallationFormTemp_Create = "CREATE TABLE IF NOT EXISTS AWSInstallationFormTemp(AndroidUniqueId TEXT,StateId TEXT,DistrictId TEXT,BlockId TEXT,VillageName TEXT,SurveyDate TEXT,BarCode TEXT,HostName TEXT,HostAddress TEXT,LandMark TEXT,MobileNo TEXT,AWSPropertyId TEXT,HostBankAccountNo TEXT,HostAccountHolderName TEXT,Bank TEXT,IFSC TEXT,Branch TEXT,ATRHSesnorMake TEXT,ATRHSesnorModel TEXT,AnemometerMake TEXT,AnemometerModel TEXT,RainGaugeSesnorMake TEXT,RaingaugeSesnorModel TEXT,DataLoggerMake TEXT,DataLoggerModel TEXT,SolarRadiationMake TEXT,SolarRadiationModel TEXT,PressureSensorMake TEXT,PressureSensorModel TEXT,SoilMoisturesensorMake TEXT,SoilMoisturesensorModel TEXT,SoilTemperatureSensorMake TEXT,SoilTemperatureSensorModel TEXT,LeafWetnessSensorMake TEXT,LeafWetnessSensorModel TEXT,SunShineSensorMake TEXT,SunShineSensorModel TEXT,DataLoggerIMEINo TEXT,SIMNumber TEXT,ServiceProviderId TEXT,SDCardStorageMemmory TEXT,SolarPanelMakePerWatts TEXT,SolarPanelOutputVoltage TEXT,BatteryMakeModel TEXT,BatteryOutputVoltage TEXT,IsAWSInstalledAsPerGuidelines TEXT,HeightOfAWSPole TEXT,IsObstaclesNear TEXT,AWSObstacleDistance TEXT,IsDataTransmitted TEXT,Comments TEXT,AWSLatitude TEXT,AWSLongitude TEXT,AWSAccuracy TEXT,Latitude TEXT,Longitude TEXT,Accuracy TEXT,AndroidCreateDate TEXT)",
            AWSInstallationForm_Create = "CREATE TABLE IF NOT EXISTS AWSInstallationForm(AndroidUniqueId TEXT,StateId TEXT,DistrictId TEXT,BlockId TEXT,VillageName TEXT,SurveyDate TEXT,BarCode TEXT,HostName TEXT,HostAddress TEXT,LandMark TEXT,MobileNo TEXT,AWSPropertyId TEXT,HostBankAccountNo TEXT,HostAccountHolderName TEXT,Bank TEXT,IFSC TEXT,Branch TEXT,ATRHSesnorMake TEXT,ATRHSesnorModel TEXT,AnemometerMake TEXT,AnemometerModel TEXT,RainGaugeSesnorMake TEXT,RaingaugeSesnorModel TEXT,DataLoggerMake TEXT,DataLoggerModel TEXT,SolarRadiationMake TEXT,SolarRadiationModel TEXT,PressureSensorMake TEXT,PressureSensorModel TEXT,SoilMoisturesensorMake TEXT,SoilMoisturesensorModel TEXT,SoilTemperatureSensorMake TEXT,SoilTemperatureSensorModel TEXT,LeafWetnessSensorMake TEXT,LeafWetnessSensorModel TEXT,SunShineSensorMake TEXT,SunShineSensorModel TEXT,DataLoggerIMEINo TEXT,SIMNumber TEXT,ServiceProviderId TEXT,SDCardStorageMemmory TEXT,SolarPanelMakePerWatts TEXT,SolarPanelOutputVoltage TEXT,BatteryMakeModel TEXT,BatteryOutputVoltage TEXT,IsAWSInstalledAsPerGuidelines TEXT,HeightOfAWSPole TEXT,IsObstaclesNear TEXT,AWSObstacleDistance TEXT,IsDataTransmitted TEXT,Comments TEXT,AWSLatitude TEXT,AWSLongitude TEXT,AWSAccuracy TEXT,Latitude TEXT,Longitude TEXT,Accuracy TEXT,AndroidCreateDate TEXT, IsSync TEXT)",
            InsuredCropVerificationFormTemp_Create = "CREATE TABLE IF NOT EXISTS InsuredCropVerificationFormTemp(ApplicationNumber TEXT,SeasonId TEXT,StateId TEXT,DistrictId TEXT,BlockId TEXT,RevenueCircleId TEXT, PanchayatId TEXT,PanchayatName TEXT,PanchayatMasterStatus TEXT,VillageId TEXT,VillageName TEXT,VillageMasterStatus TEXT,IsFarmerAvailable TEXT,FarmerName TEXT,MobileNo TEXT,FarmerType TEXT,CropId TEXT, CropOnField TEXT, Irrigation TEXT, SurveyKhasraNo TEXT,SubSurveyNo TEXT,HissaNumber TEXT,LandUnits TEXT,SowingArea TEXT,CropPatternId TEXT,CropName TEXT,SurveyDate TEXT,Comments TEXT,Latitude TEXT,Longitude TEXT,Accuracy TEXT,InsuredLatitude TEXT,InsuredLongitude TEXT,InsuredAccuracy TEXT,AndroidUniqueId TEXT,AndroidCreateDate TEXT,CreateBy TEXT,CreateMachine TEXT, SearchId TEXT)",
            InsuredCropVerificationForm_Create = "CREATE TABLE IF NOT EXISTS InsuredCropVerificationForm(ApplicationNumber TEXT,SeasonId TEXT,StateId TEXT,DistrictId TEXT,BlockId TEXT,RevenueCircleId TEXT, PanchayatId TEXT,PanchayatName TEXT,PanchayatMasterStatus TEXT,VillageId TEXT,VillageName TEXT,VillageMasterStatus TEXT,IsFarmerAvailable TEXT,FarmerName TEXT,MobileNo TEXT,FarmerType TEXT,CropId TEXT, CropOnField TEXT, Irrigation TEXT, SurveyKhasraNo TEXT,SubSurveyNo TEXT,HissaNumber TEXT,LandUnits TEXT,SowingArea TEXT,CropPatternId TEXT,CropName TEXT,SurveyDate TEXT,Comments TEXT,Latitude TEXT,Longitude TEXT,Accuracy TEXT,InsuredLatitude TEXT,InsuredLongitude TEXT,InsuredAccuracy TEXT,AndroidUniqueId TEXT,AndroidCreateDate TEXT,CreateBy TEXT,CreateMachine TEXT, IsSync TEXT, SearchId TEXT)",
            InsuredCropVerificationFormSearchTemp_Create = "CREATE TABLE IF NOT EXISTS InsuredCropVerificationFormSearchTemp(SearchId TEXT, ApplicationNumber TEXT, SeasonId TEXT, SeasonName TEXT, StateId TEXT, StateName TEXT, DistrictId TEXT, DistrictName TEXT, BlockId TEXT, BlockName TEXT, RevenueCircleId TEXT, RevenueCircle TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT, FarmerType TEXT, CropId TEXT, CropTitle TEXT, Irrigation TEXT, SurveyKhasraNo TEXT, SubSurveyNo TEXT, HissaNumber TEXT, InsuredArea TEXT)",
            NEWCCEFormTemp_Create = "CREATE TABLE IF NOT EXISTS NEWCCEFormTemp(AndroidUniqueId TEXT,SeasonId TEXT, SeasonName TEXT,CCEType TEXT,CropId TEXT,CropName TEXT,PickingType TEXT,CropSurveyFormId TEXT,CCEMSurveyFormId TEXT, StateId TEXT, StateName TEXT, DistrictId TEXT, DistrictName TEXT, BlockId TEXT, BlockName TEXT, RevenueCircleId TEXT,RevenueCircleName TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT,Irrigation TEXT,IrrigationSourceId TEXT, IrrigationSource TEXT,SeedCompanyName TEXT,CropVarietyId TEXT, CropVariety TEXT,SowingArea TEXT,KhasraSurveyCCEPlotNo TEXT,SurveyDate TEXT, AndroidCreateDate TEXT)",
            NEWCCEForm_Create = "CREATE TABLE IF NOT EXISTS NEWCCEForm(AndroidUniqueId TEXT,SeasonId TEXT, SeasonName TEXT,CCEType TEXT,CropId TEXT,CropName TEXT,PickingType TEXT,CropSurveyFormId TEXT,CCEMSurveyFormId TEXT, StateId TEXT, StateName TEXT, DistrictId TEXT, DistrictName TEXT, BlockId TEXT, BlockName TEXT, RevenueCircleId TEXT,RevenueCircleName TEXT, PanchayatId TEXT, PanchayatName TEXT, VillageId TEXT, VillageName TEXT, FarmerName TEXT, MobileNo TEXT,Irrigation TEXT,IrrigationSourceId TEXT, IrrigationSource TEXT,SeedCompanyName TEXT,CropVarietyId TEXT, CropVariety TEXT,SowingArea TEXT,KhasraSurveyCCEPlotNo TEXT,SurveyDate TEXT,SWCornerLatitude TEXT, SWCornerLongitude TEXT, SWCornerAccuracy TEXT, IsMixedCrop TEXT, MixedCropName TEXT,RowsUnderStudy TEXT, GeneralCropCondition TEXT, AnyDamage TEXT, WeedInPlot TEXT, CropConditionCompare TEXT,PlotSizeId TEXT, PlantCount TEXT, PlantHeight TEXT, SquareCount TEXT,FlowerCount TEXT, BallCount TEXT, BallPicked TEXT,WeightTypeId TEXT,WeightType TEXT, WeightOfCotton TEXT,ExperimentWeight TEXT,ExpectedYeild TEXT," +
                    "Comments TEXT,Latitude TEXT, Longitude TEXT,Accuracy TEXT, AndroidCreateDate TEXT, CreateMachine TEXT, IsSubmitted TEXT)",
            NewCCEFormTempDocument_Create = "CREATE TABLE IF NOT EXISTS NewCCEFormTempDocument(UniqueId TEXT, FormType TEXT, FormUniqueId TEXT, PictureUploadId TEXT, FileName TEXT, Latitude TEXT, Longitude TEXT, Accuracy TEXT, AttachmentDate TEXT,CreateBy TEXT)";
    ...
    public List<CustomType> GetMasterDetails(String masterType, String filter, String formId) {
        ...
        switch (masterType) {
            ...
            case "crop":
                ...
                break;
            case "ccecrop":
                selectQuery = "SELECT CropId, CropName FROM Crop WHERE IsMultiPicking = '" + filter + "' ORDER BY CropName COLLATE NOCASE ASC";
                break;
            case "cropvariety":
            ...
            case "AllDocument":
                ...
                break;
            case "form2document":
                selectQuery = "SELECT Id||'~'|| IsGallery ||'~'|| IsCamera, Name FROM SurveyFormPictureUpload WHERE SurveyFormId ='" + filter + "' AND Id NOT IN (SELECT DISTINCT PictureUploadId FROM CCEMFormTempDocument UNION SELECT DISTINCT PictureUploadId FROM DriageFormTempDocument UNION SELECT DISTINCT PictureUploadId FROM LossAssessmentFormTempDocument) ORDER BY Name COLLATE NOCASE ASC";
                break;
            case "document":
                selectQuery = "SELECT Id, Name FROM SurveyFormPictureUpload WHERE SurveyFormId ='" + filter + "' AND Id NOT IN (SELECT DISTINCT PictureUploadId FROM CCEMFormTempDocument UNION SELECT DISTINCT PictureUploadId FROM DriageFormTempDocument UNION SELECT DISTINCT PictureUploadId FROM LossAssessmentFormTempDocument UNION SELECT DISTINCT PictureUploadId FROM NewCCEFormTempDocument) ORDER BY Name COLLATE NOCASE ASC";
                break;
            case "lessdocument":
            ...
            case "property":
                ...
                break;
            case "CCEType":
                selectQuery = "SELECT 'Multi Picking Crop','Multi Picking Crop' UNION SELECT 'Single Crop','Single Crop' ";
                break;
            case "pickingtype":
                if (filter.equalsIgnoreCase("1"))
                    selectQuery = "SELECT '1st Picking','1st Picking' UNION SELECT '2nd Picking','2nd Picking' UNION SELECT '3 Picking','3 Picking' UNION SELECT '4th Picking', '4th Picking' UNION SELECT '5th Picking','5th Picking' UNION SELECT '6th Picking','6th Picking'";
                else
                    selectQuery = "SELECT '1st Picking','1st Picking'";
                break;
        }
        ...
        else if (masterType.equalsIgnoreCase("crop") || masterType.equalsIgnoreCase("ccecrop"))
        ...
        else if (masterType.equalsIgnoreCase("CCEType"))
            labels.add(new CustomType("0", "...Select CCE Type"));
        else if (masterType.equalsIgnoreCase("pickingtype"))
            labels.add(new CustomType("0", "...Select Picking Type"));
        else
    ...
    public String Insert_InitialCCEMFormTempData(String androidUniqueId, String seasonId, String randomNo, String stateId, String districtId, String blockId, String revenueCircleId, String panchayatId, String panchayatName, String villageId, String villageName, String farmerName, String mobileNo, String officerName, String officerDesignation, String officerContactNo, String swCLongitude, String swCLatitude, String swcAccuracy) {
        try {
    ...
    //<editor-fold desc="Code to Update Data in CCEMFormTemp Table">
    public String Update_CCEMFormTempDataThirdStep(String plotSizeId, String weightTypeId, String experimentWeight, String isDriageDone, String isForm2FIlled, String isCopyOfForm2Collected, String isWIttnessFormFilled, String comments) {
        //String swCLongitude, String swCLatitude, String swcAccuracy,
        //SWCLongitude = '" + swCLongitude + "',SWCLatitude = '" + swCLatitude + "', SWCAccuracy = '" + swcAccuracy + "',
        try {

            db.execSQL("UPDATE CCEMFormTemp SET PlotSizeId ='" + plotSizeId + "', WeightTypeId ='" + weightTypeId + "', ExperimentWeight ='" + experimentWeight + "', IsDriageDone = '" + isDriageDone + "', IsForm2FIlled ='" + isForm2FIlled + "', IsCopyOfForm2Collected ='" + isCopyOfForm2Collected + "', IsWIttnessFormFilled ='" + isWIttnessFormFilled + "', Comments ='" + comments + "' ");
    ...
    //<editor-fold desc="Code to delete File details from CCEMFormTempDocument table by form Type">
    public String DeleteCCEMFormTempDocumentByType(String formType) {
        result = "fail";
        db.execSQL("DELETE FROM CCEMFormTempDocument WHERE FormType ='" + formType + "' ");
        result = "success";
        return result;
    }
    //</editor-fold>
    ...
    public ArrayList<HashMap<String, String>> getUnSyncCCEMImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='CCEM Survey Form' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
    ...
    public String Insert_CropSurvey(String uniqueId, String seasonId, String season, String stateId, String state, String districtId, String district, String blockId, String block, String farmerName, String mobileNo, String surveyDate, String cropId, String crop, String cropVarietyId, String cropVariety, String varietyName, String cropDuration, String cropDurationDay, String approxCropArea, String contigeousCropArea, String irrigation, String irrigationSourceId, String irrigationSource, String sowingDate, String harvestDate, String cropStageId, String cropStage, String cropAge, String plantDensity, String weeds, String isDamagedByPest, String averageYield, String expectedYield, String comments, String latitudeInside, String longitudeInside, String accuracyInside, String createBy, String isFarmerAvailable, String cropLandUnitId, String cropLandUnit, String cropAreaCurrent, String cropAreaPast, String extentAreaPastId, String extentAreaPast, String reasonReplacedBy, String cropPatternId, String cropPattern, String cropConditionId, String cropCondition, String damageType, String damageFileName, String weightUnitId, String weightUnit, String landUnitId, String landUnit, String gPSType, String gPSPolygonType, String damageFilePath, String plotSizeId, String plotSize, String plantCount, String plantHeightInFeet, String branchCount, String squareCount, String flowerCount, String ballCount, String expectedFirstPickingDate, String companySeed) {
        try {
            ...
            newValues.put("PlotSizeId", plotSizeId);
            newValues.put("PlotSize", plotSize);
            ...
            newValues.put("CompanySeed", companySeed);
...
//</editor-fold>
    ...
    public ArrayList<HashMap<String, String>> getCropSurveyByUniqueId(String uniqueId, String isTemp) {
        ...
        while (cursor.moveToNext()) {
            ...
            map.put("PlotSizeId", cursor.getString(61));
            map.put("PlotSize", cursor.getString(62));
            map.put("PlantCount", cursor.getString(63));
            map.put("PlantHeightInFeet", cursor.getString(64));
            map.put("BranchCount", cursor.getString(65));
            map.put("SquareCount", cursor.getString(66));
            map.put("FlowerCount", cursor.getString(67));
            map.put("BallCount", cursor.getString(68));
            map.put("ExpectedFirstPickingDate", cursor.getString(69));
            map.put("CompanySeed", cursor.getString(70));
            list.add(map);
        }
        cursor.close();
        return list;
    ...
    //<editor-fold desc="Code to get Loss Assesment Form Detail From SearchResult">
    public ArrayList<String> getLossAssesmentSearchDetails(String id) {
        ArrayList<String> lossAssesmentFormDetails = new ArrayList<String>();
        selectQuery = "SELECT SearchId, SeasonId, SeasonName, ApplicationNumber, ClaimIntimationNo, StateId, StateName, DistrictId, DistrictName, BlockId, BlockName, RevenueCircleId, RevenueCircle, PanchayatId, PanchayatName, VillageId, VillageName, FarmerName, FatherName, MobileNo, CropId, CropName, InsuredArea, KhasraSurveyNo, DateofLoss, DateOfLossIntimation, LossCauseId, LossCause " +
                " FROM LossAssessmentSearchTemp " +
                " WHERE SearchId ='" + id + "' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            lossAssesmentFormDetails.add(cursor.getString(0));
            lossAssesmentFormDetails.add(cursor.getString(1));
            lossAssesmentFormDetails.add(cursor.getString(2));
            lossAssesmentFormDetails.add(cursor.getString(3));
            lossAssesmentFormDetails.add(cursor.getString(4));
            lossAssesmentFormDetails.add(cursor.getString(5));
            lossAssesmentFormDetails.add(cursor.getString(6));
            lossAssesmentFormDetails.add(cursor.getString(7));
            lossAssesmentFormDetails.add(cursor.getString(8));
            lossAssesmentFormDetails.add(cursor.getString(9));
            lossAssesmentFormDetails.add(cursor.getString(10));
            lossAssesmentFormDetails.add(cursor.getString(11));
            lossAssesmentFormDetails.add(cursor.getString(12));
            lossAssesmentFormDetails.add(cursor.getString(13));
            lossAssesmentFormDetails.add(cursor.getString(14));
            lossAssesmentFormDetails.add(cursor.getString(15));
            lossAssesmentFormDetails.add(cursor.getString(16));
            lossAssesmentFormDetails.add(cursor.getString(17));
            lossAssesmentFormDetails.add(cursor.getString(18));
            lossAssesmentFormDetails.add(cursor.getString(19));
            lossAssesmentFormDetails.add(cursor.getString(20));
            lossAssesmentFormDetails.add(cursor.getString(21));
            lossAssesmentFormDetails.add(cursor.getString(22));
            lossAssesmentFormDetails.add(cursor.getString(23));
            lossAssesmentFormDetails.add(cursor.getString(24));
            lossAssesmentFormDetails.add(cursor.getString(25));
            lossAssesmentFormDetails.add(cursor.getString(26));
            lossAssesmentFormDetails.add(cursor.getString(27));

        }
        cursor.close();

        return lossAssesmentFormDetails;
    }
    //</editor-fold>
    ...
    public ArrayList<String> getLAFormTempDetails() {
        ...
        while (cursor.moveToNext()) {
            ...
            laformdetails.add(cursor.getString(39));
            laformdetails.add(cursor.getString(40));
            laformdetails.add(cursor.getString(41));
        }
        cursor.close();
    ...
    public String Insert_InitialLossAssessmentFormTempData(String androidUniqueId, String seasonId, String stateId, String districtId, String blockId, String revenueCircleId, String panchayatId, String panchayatName, String villageId, String villageName, String farmerName, String mobileNo, String farmerType, String ownershipId, String cropId, String cropSowingArea, String insuredFarmerFather, String insuredArea, String claimIntimationNo, String applicationNumber, String searchId) {
        try {
            ...
            if (existCount == 0) {
                ...
                newValues.put("ClaimIntimationNo", claimIntimationNo);
                newValues.put("ApplicationNumber", applicationNumber);
                newValues.put("SearchId", searchId);
                ...
                db.execSQL("UPDATE LossAssessmentTemp SET SeasonId = '" + seasonId + "', StateId= '" + stateId + "', DistrictId ='" + districtId + "', BlockId = '" + blockId + "', RevenueCircleId = '" + revenueCircleId + "', PanchayatId = '" + panchayatId + "', PanchayatName = '" + panchayatName + "', VillageId = '" + villageId + "', VillageName = '" + villageName + "', FarmerName = '" + farmerName + "', MobileNo = '" + mobileNo + "', SurveyDate = '" + getDateTime() + "', FarmerType = '" + farmerType + "', OwnershipTypeId = '" + ownershipId + "', CropId = '" + cropId + "', SowingArea = '" + cropSowingArea + "', FatherName = '" + insuredFarmerFather + "', InsuredArea = '" + insuredArea + "' , ClaimIntimationNo = '" + claimIntimationNo + "' , ApplicationNumber = '" + applicationNumber + "', SearchId = '" + searchId + "' WHERE AndroidUniqueId = '" + androidUniqueId + "' ");
            }
            result = "success";
            return result;
        } catch (Exception e) {
    ...
    public ArrayList<HashMap<String, String>> getCauseOfLoss() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT DISTINCT lc.LossCauseId, lc.LossCauseName, (CASE WHEN tp.CauseOfLossId IS NOT NULL THEN '1' ELSE '0' END) AS IsSelected FROM LossCause lc LEFT JOIN LossAssessmentCOLTemp tp ON lc.LossCauseId = tp.CauseOfLossId ORDER BY lc.LossCauseName COLLATE NOCASE ASC ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
    ...
    public String Insert_LossAssessmentFormDocument(String uniqueId, String latitude, String longitude, String accuracy, String userId) {
        try {
            db.execSQL("INSERT INTO LossAssessmentForm(AndroidUniqueId, SeasonId, StateId, DistrictId, BlockId, RevenueCircleId, PanchayatId, PanchayatName, VillageId, VillageName, FarmerName, MobileNo, SurveyDate, FarmerType, OwnershipTypeId, CropId, SowingArea, KhasraSurveyNo, DateOfSowing, DateofLoss, DateOfLossIntimation, StageOfLossId, LossPercentage, OfficerName, OfficerDesignation, OfficerContactNo, Comments, Latitude, Longitude, Accuracy,  AndroidCreateDate, FatherName, InsuredArea, ApproxArea, PremiumAmount, ClaimIntimationNo, ApplicationNumber, SearchId) SELECT AndroidUniqueId, SeasonId, StateId, DistrictId, BlockId, RevenueCircleId, PanchayatId, PanchayatName, VillageId, VillageName, FarmerName, MobileNo, SurveyDate, FarmerType, OwnershipTypeId, CropId, SowingArea, KhasraSurveyNo, DateOfSowing, DateofLoss, DateOfLossIntimation, StageOfLossId, LossPercentage, OfficerName, OfficerDesignation, OfficerContactNo, Comments,'" + latitude + "','" + longitude + "', '" + accuracy + "', '" + getDateTime() + "', FatherName, InsuredArea, ApproxArea, PremiumAmount, ClaimIntimationNo, ApplicationNumber, SearchId FROM LossAssessmentTemp WHERE AndroidUniqueId = '" + uniqueId + "'");
    ...
    public ArrayList<HashMap<String, String>> GetLossAssessmentSumaryData() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT DISTINCT frm.AndroidUniqueId, sm.Season||'-'||sm.Year, cr.CropName, frm.FarmerName, frm.MobileNo, frm.SurveyDate, frm.KhasraSurveyNo, frm.ClaimIntimationNo FROM LossAssessmentForm frm, SeasonMaster sm, Crop cr WHERE frm.SeasonId = sm.Id AND frm.CropId = cr.CropId  ORDER BY frm.SurveyDate";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
            ...
            map.put("ClaimIntimationNo", cursor.getString(7));
            list.add(map);
        }
        cursor.close();
        return list;
    ...
    public ArrayList<HashMap<String, String>> GetUnSyncLossAssessmentForms() {
        ...
        selectQuery = "SELECT AndroidUniqueId, SeasonId, StateId, DistrictId, BlockId, RevenueCircleId, PanchayatId, PanchayatName, VillageId, VillageName, FarmerName, MobileNo, SurveyDate, FarmerType, OwnershipTypeId, CropId, SowingArea, KhasraSurveyNo, DateOfSowing, DateofLoss, DateOfLossIntimation, StageOfLossId, LossPercentage, OfficerName, OfficerDesignation, OfficerContactNo, Comments, Latitude, Longitude, Accuracy, AndroidCreateDate, FatherName, InsuredArea, ApproxArea, PremiumAmount, REPLACE(ClaimIntimationNo,'&','`'), ApplicationNumber, SearchId FROM LossAssessmentForm WHERE IsSync IS NULL";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<>();
            map.put("AndroidUniqueId", cursor.getString(0));
            ...
            map.put("ClaimIntimationNo", cursor.getString(35));
            map.put("ApplicationNumber", cursor.getString(36));
            map.put("SearchId", cursor.getString(37));
            wordList.add(map);
        }
        cursor.close();
        return wordList;
    ...
    //<editor-fold desc="Method to Get Summary Data from Search Data of Loss Assesment Form">
    public ArrayList<HashMap<String, String>> getLossAssesmentFormSearchData() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT DISTINCT tmp.SearchId, tmp.ApplicationNumber, tmp.SeasonName, tmp.CropName, tmp.FarmerName, tmp.KhasraSurveyNo, tmp.ClaimIntimationNo FROM LossAssessmentSearchTemp tmp LEFT OUTER JOIN LossAssessmentForm main ON tmp.SearchId = main.SearchId WHERE main.AndroidUniqueId IS NULL ORDER BY tmp.ApplicationNumber ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("SearchId", cursor.getString(0));
            map.put("ApplicationNumber", cursor.getString(1));
            map.put("Season", cursor.getString(2));
            map.put("Crop", cursor.getString(3));
            map.put("FarmerName", cursor.getString(4));
            map.put("KhasraSurveyNo", cursor.getString(5));
            map.put("ClaimIntimationNo", cursor.getString(6));
            list.add(map);
        }
        cursor.close();
        return list;
    ...
    //<editor-fold desc="Code to Insert Data in LossAssessmentSearchTemp Table">
    public String Insert_LossAssessmentSearchTemp(String SearchId, String SeasonId, String SeasonName, String ApplicationNumber, String ClaimIntimationNo, String StateId, String StateName, String DistrictId, String DistrictName, String BlockId, String BlockName, String RevenueCircleId, String RevenueCircle, String PanchayatId, String PanchayatName, String VillageId, String VillageName, String FarmerName, String FatherName, String MobileNo, String CropId, String CropName, String InsuredArea, String KhasraSurveyNo, String DateofLoss, String DateOfLossIntimation, String LossCauseId, String LossCause) {
        ...
        try {
            ...
            newValues.put("SearchId", SearchId);
            newValues.put("SeasonId", SeasonId);
            newValues.put("SeasonName", SeasonName);
            newValues.put("ApplicationNumber", ApplicationNumber);
            newValues.put("ClaimIntimationNo", ClaimIntimationNo);
            newValues.put("StateId", StateId);
            newValues.put("StateName", StateName);
            ...
            newValues.put("CropName", CropName);
            newValues.put("InsuredArea", InsuredArea);
            newValues.put("KhasraSurveyNo", KhasraSurveyNo);
            newValues.put("DateofLoss", DateofLoss);
            newValues.put("DateOfLossIntimation", DateOfLossIntimation);
            newValues.put("LossCauseId", LossCauseId);
            newValues.put("LossCause", LossCause);

            db.insert("LossAssessmentSearchTemp", null, newValues);
            result = "success";
            return result;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean IslogoutAllowed() {
        ...
        int countCCEForm, countDocument, countDriage, countLoss, countCropSurvey, countCropMonitoring, countSiteSurvey, countAWSMaintenanceForm, countRoadSideCrowdSourcing, countTraderFieldSurvey, countAWSInstallation, counInsuredForm;

        selectQuery = "SELECT * FROM CCEMForm";
        cursor = db.rawQuery(selectQuery, null);
        countCCEForm = cursor.getCount();

        selectQuery = "SELECT * FROM InsuredCropVerificationForm";
        cursor = db.rawQuery(selectQuery, null);
        counInsuredForm = cursor.getCount();
        ...
        cursor.close();
        if (countCCEForm > 0 || countDocument > 0 || countDriage > 0 || countLoss > 0 || countCropSurvey > 0 || countCropMonitoring > 0 || countSiteSurvey > 0 || countAWSMaintenanceForm > 0 || countRoadSideCrowdSourcing > 0 || countTraderFieldSurvey > 0 || countAWSInstallation > 0 || counInsuredForm > 0)
            isRequired = false;
...
//</editor-fold>
    ...
    //<editor-fold desc="Method to Get All UnSync Crop Monitoring Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncCropMonitoringForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.AndroidUniqueId, f.SeasonId, f.StateId, f.DistrictId, f.BlockId, f.FarmerName, f.MobileNo, f.SurveyDate, f.CropId, f.ExpectedHarvestDate, f.CropStageId, f.CropAge, f.CropHealth, f.PlantDensity, f.Weeds, f.IsDamagedByPest, f.AverageYield, f.ExpectedYield, f.Comments, f.LatitudeInsideField, f.LongitudeInsideField, f.AccuracyInsideField, f.Latitude, f.Longitude, f.Accuracy,f.AndroidCreateDate, f.RevenueCircleId, f.PanchayatId, f.PanchayatName, f.VillageId, f.VillageName FROM CropMonitoring f WHERE f.IsSync IS NULL ";
    ...
    //<editor-fold desc="Method to Get Selected All CropMonitoring Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncCropMonitoringImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId, f.UniqueId, f.PictureUploadId, f.FileName, f.Latitude, f.Longitude, f.Accuracy, f.AttachmentDate FROM CCEMFormDocument  f  WHERE f.FormType ='Crop Monitoring' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    public ArrayList<HashMap<String, String>> getSelectedUnSyncCropSurveyForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.seasonId, f.stateId, f.districtId, f.blockId, f.farmerName, f.mobileNo, f.cropId, f.cropVarietyId, f.varietyName, f.cropDuration, CASE WHEN f.cropDurationDay ='' THEN 0 ELSE f.cropDurationDay END, f.approxCropArea, f.contigeousCropArea, f.irrigation, f.irrigationSourceId, f.sowingDate, f.harvestDate, f.cropStageId, CASE WHEN f.cropAge ='' THEN 0 ELSE f.cropAge END, '' AS cropHealth, f.plantDensity, f.weeds, f.isDamagedByPest, CASE WHEN f.averageYield ='' THEN 0 ELSE f.averageYield END, CASE WHEN f.expectedYield ='' THEN 0 ELSE f.expectedYield END, f.comments, f.latitudeInside, f.longitudeInside, f.accuracyInside, f.latitude, f.longitude, f.accuracy, f.UniqueId, f.createDate, f.IsFarmerAvailable, f.CropLandUnitId, CASE WHEN f.CropAreaCurrent ='' THEN 0 ELSE f.CropAreaCurrent END, CASE WHEN f.CropAreaPast ='' THEN 0 ELSE f.CropAreaPast END, f.ExtentAreaPastId, f.ReasonReplacedBy, f.CropPatternId, f.CropConditionId, f.DamageType, f.DamageFileName, f.WeightUnitId, f.LandUnitId, f.GPSType, f.GPSPolygonType, f.PlotSizeId,f.PlantCount, f.PlantHeightInFeet, f.BranchCount, f.SquareCount, f.FlowerCount, f.BallCount, f.ExpectedFirstPickingDate FROM CropSurvey f, SelectedSyncData s WHERE f.IsSync = '0' AND f.isTemp ='0' AND f.UniqueId = s.FormId AND s.FormName = 'Crop Survey' AND s.IsSync IS NULL";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("SeasonId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Crop Survey Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncCropSurveyForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.seasonId, f.stateId, f.districtId, f.blockId, f.farmerName, f.mobileNo, f.cropId, f.cropVarietyId, f.varietyName, f.cropDuration, CASE WHEN f.cropDurationDay ='' THEN 0 ELSE f.cropDurationDay END, f.approxCropArea, f.contigeousCropArea, f.irrigation, f.irrigationSourceId, f.sowingDate, f.harvestDate, f.cropStageId, CASE WHEN f.cropAge ='' THEN 0 ELSE f.cropAge END, '' AS cropHealth, f.plantDensity, f.weeds, f.isDamagedByPest, CASE WHEN f.averageYield ='' THEN 0 ELSE f.averageYield END, CASE WHEN f.expectedYield ='' THEN 0 ELSE f.expectedYield END, f.comments, f.latitudeInside, f.longitudeInside, f.accuracyInside, f.latitude, f.longitude, f.accuracy, f.UniqueId, f.createDate, f.IsFarmerAvailable, f.CropLandUnitId, CASE WHEN f.CropAreaCurrent ='' THEN 0 ELSE f.CropAreaCurrent END, CASE WHEN f.CropAreaPast ='' THEN 0 ELSE f.CropAreaPast END, f.ExtentAreaPastId, f.ReasonReplacedBy, f.CropPatternId, f.CropConditionId, f.DamageType, f.DamageFileName, f.WeightUnitId, f.LandUnitId, f.GPSType, f.GPSPolygonType, f.PlotSizeId,f.PlantCount, f.PlantHeightInFeet, f.BranchCount, f.SquareCount, f.FlowerCount, f.BallCount, f.ExpectedFirstPickingDate, f.CompanySeed FROM CropSurvey f WHERE f.IsSync = '0' AND f.isTemp ='0' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("SeasonId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Crop Survey Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncCropSurveyImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='Crop Survey' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Crop Survey Coordinates">
    public ArrayList<HashMap<String, String>> GetAllUnSyncCropSurveyCoordinates() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.MasterUniqueId, f.Latitude, f.Longitude, f.Accuracy, f.CreateDate FROM CropSurveyGeoTag f ORDER BY Id";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("MasterUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Form 2 Collection Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncForm2CollectionForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.AndroidUniqueId,f.SeasonId, f.RandomNo, f.StateId, f.DistrictId, f.BlockId, f.RevenueCircleId, f.PanchayatId, f.PanchayatName, f.VillageId, f.VillageName, f.FarmerName, f.MobileNo, f.SurveyDate, f.OfficerName, f.OfficerDesignation, f.OfficerContactNo, f.CropId, f.HighestKhasraSurveyNo, f.CCEPlotKhasraSurveyNo,f.PlotSizeId, f.WetWeight, f.DryWeight, f.Comments, f.Latitude, f.Longitude, f.Accuracy,f.AndroidCreateDate, (CASE WHEN f.CCEMSurveyFormId='0' THEN '-1' ELSE f.CCEMSurveyFormId END) FROM Form2Collection f ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("AndroidUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Form2Collection Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncForm2CollectionImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='Form 2 Collection Form' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync LossAssessment Forms">
    public ArrayList<HashMap<String, String>> GetAllUnSyncLossAssessmentForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<>();
        selectQuery = "SELECT f.AndroidUniqueId, f.SeasonId, f.StateId, f.DistrictId, f.BlockId, f.RevenueCircleId, f.PanchayatId, f.PanchayatName, f.VillageId, f.VillageName, f.FarmerName, f.MobileNo, f.SurveyDate, f.FarmerType, f.OwnershipTypeId, f.CropId, f.SowingArea, f.KhasraSurveyNo, f.DateOfSowing, f.DateofLoss, f.DateOfLossIntimation, f.StageOfLossId, f.LossPercentage, f.OfficerName, f.OfficerDesignation, f.OfficerContactNo, f.Comments, f.Latitude, f.Longitude, f.Accuracy, f.AndroidCreateDate, f.FatherName, f.InsuredArea, f.ApproxArea, f.PremiumAmount, Replace(f.ClaimIntimationNo,'&','`'), f.ApplicationNumber, f.SearchId FROM LossAssessmentForm f WHERE f.IsSync IS NULL ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("AndroidUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Loss Assessment Images">
    public ArrayList<HashMap<String, String>> GetAllUnSyncLossAssessmentImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='Loss Assessment'  ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("LossAssessmentAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get Selected UnSync Loss Assessment Coordinates">
    public ArrayList<HashMap<String, String>> GetAllUnSyncLossAssessmentCoordinates() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.LossAssessmentUniqueId, f.Id, f.Latitude, f.Longitude, f.Accuracy, f.CreateDate FROM LossAssessmentGeoTag f ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("LossAssessmentAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Site Survey Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncSiteSurveyForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.UniqueId, f.StateId, f.DistrictId, f.BlockId, f.RevenueCircleId, f.PanchayatId, f.VillageId, f.SurveyDate, f.PropertyId, f.IsObstacles, f.IsEarthquake, f.IsBigTrees, f.IsLargeWater, f.IsHighTension, f.IsPowerCable, f.ServiceProviderId, f.IsProposed, f.IsRecommended, f.Comments, f.Latitude, f.Longitude, f.Accuracy, f.CreateBy, f.CreateDate, f.OtherPanchayat, f.OtherVillage, f.SeasonId,f.SiteLatitude, f.SiteLongitude, f.SiteAccuracy FROM SiteSurvey f WHERE f.IsSync = '0' AND f.isTemp ='0' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Site Survey Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncSiteSurveyImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='Site Survey'  ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    public ArrayList<HashMap<String, String>> getSelectedAttachmentForSync() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT DISTINCT UniqueId, (CASE WHEN FormType='CCEM Survey Form' THEN 'CCEM' WHEN FormType='Driage Form' THEN 'Driage' WHEN FormType='Form 2 Collection Form' THEN 'Form2Collection' WHEN FormType = 'Loss Assessment' THEN 'LossAssessment' WHEN FormType='Crop Survey' THEN  'CropSurvey' WHEN FormType='Site Survey' THEN  'SiteSurvey' WHEN FormType='Crop Monitoring' THEN  'CropMonitoring' WHEN FormType='AWS Maintenance' THEN 'AWSMaintenance' WHEN FormType='TraderFieldSurvey' THEN 'TraderFieldSurvey' WHEN FormType='RoadSideCrowdSourcing' THEN 'RoadSideCrowdSourcing' WHEN FormType='AWS Installation Form' THEN 'AWSInstallation' WHEN FormType='InsuredCropVerificationForm' THEN 'InsuredCropVerificationForm' ELSE 'Other' END), FileName FROM CCEMFormDocument WHERE FormUniqueId IN (SELECT FormId FROM SelectedSyncData WHERE IsSync ='1') UNION ALL SELECT UniqueId, (CASE WHEN FormType='CCEM Survey Form' THEN 'CCEM' WHEN FormType='Driage Form' THEN 'Driage' WHEN FormType='Form 2 Collection Form' THEN 'Form2Collection' WHEN FormType = 'Loss Assessment' THEN 'LossAssessment' WHEN FormType='Crop Survey' THEN  'CropSurvey' WHEN FormType='Site Survey' THEN  'SiteSurvey' WHEN FormType='Crop Monitoring' THEN  'CropMonitoring' WHEN FormType='AWS Maintenance' THEN 'AWSMaintenance' WHEN FormType='TraderFieldSurvey' THEN 'TraderFieldSurvey' WHEN FormType='RoadSideCrowdSourcing' THEN 'RoadSideCrowdSourcing' WHEN FormType='AWS Installation Form' THEN 'AWSInstallation' WHEN FormType='InsuredCropVerificationForm' THEN 'InsuredCropVerificationForm' ELSE 'Other' END), FileName FROM CCEMFormDocument WHERE FormUniqueId NOT IN (SELECT UniqueId FROM (SELECT AndroidUniqueId AS UniqueId FROM CCEMForm UNION ALL SELECT AndroidUniqueId AS UniqueId FROM CropMonitoring UNION ALL SELECT UniqueId FROM CropSurvey UNION ALL SELECT AndroidUniqueId AS UniqueId FROM DriageForm UNION ALL SELECT AndroidUniqueId AS UniqueId FROM Form2Collection UNION ALL SELECT AndroidUniqueId AS UniqueId FROM LossAssessmentForm UNION ALL SELECT UniqueId FROM SiteSurvey UNION ALL SELECT UniqueId FROM AWSMaintenanceForm UNION ALL SELECT UniqueId FROM TraderFieldSurvey UNION ALL SELECT AndroidUniqueId AS UniqueId FROM AWSInstallationForm UNION ALL SELECT UniqueId FROM RoadSideCrowdSourcing UNION ALL SELECT AndroidUniqueId FROM InsuredCropVerificationForm  UNION ALL SELECT FormId FROM SelectedSyncData WHERE IsSync = '1') main)";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
    ...
    public ArrayList<String> getAWSMaintenanceFormTempDetails(String uniqueId, String isTemp) {
        ...
        if (isTemp.equalsIgnoreCase("1"))
            selectQuery = "SELECT f.UniqueId, f.StateId, f.State, f.DistrictId, f.District, f.BlockId, f.Block, f.RevenueCircleId, f.PanchayatId, ifnull(f.PanchayatName,''), f.VillageId,ifnull(f.VillageName,''), ifnull(f.BarCodeScan,''), ifnull(SUBSTR(f.LastScanDate,1,10),''), f.PurposeOfVisitId, f.PurposeOfVisit, ifnull(f.ProblemIdentified,''), ifnull(f.AnyFaultyComponent,''), ifnull(f.ReasonForRelocation,''), f.IsSensorWorking, f.SensorName, f.BatteryVoltage, f.SolarPanelVoltage, ifnull(f.IMEINumber,''), f.SIMNumber, f.ServiceProviderId, f.ServiceProvider, f.IsDataTransmitted, f.AWSLatitude, f.AWSLongitude, f.AWSAccuracy, f.PropertyId, f.Property, f.HostPaymentPaidUpto, f.Comments, f.CreateBy, f.CreateDate, f.AnyFaultyComponentId, f.SensorId, rc.RevenueCircleName, (CASE WHEN f.PanchayatId = '99999' THEN 'Others' ELSE pc.PanchayatName END), ifnull(f.PanchayatName,''), (CASE WHEN f.VillageId = '99999' THEN 'Others' ELSE vl.VillageName END), ifnull(f.VillageName,'') FROM AWSMaintenanceForm f  LEFT OUTER JOIN Panchayat pc ON f.PanchayatId = pc.PanchayatId LEFT OUTER JOIN Village vl ON f.VillageId = vl.VillageId,RevenueCircle rc WHERE f.IsTemp IS NULL AND f.RevenueCircleId = rc.RevenueCircleId";
        else
            selectQuery = "SELECT f.UniqueId, f.StateId, f.State, f.DistrictId, f.District, f.BlockId, f.Block, f.RevenueCircleId, f.PanchayatId, ifnull(f.PanchayatName,''), f.VillageId,ifnull(f.VillageName,''), ifnull(f.BarCodeScan,''), ifnull(SUBSTR(f.LastScanDate,1,10),''), f.PurposeOfVisitId, f.PurposeOfVisit, ifnull(f.ProblemIdentified,''), ifnull(f.AnyFaultyComponent,''), ifnull(f.ReasonForRelocation,''), f.IsSensorWorking, f.SensorName, f.BatteryVoltage, f.SolarPanelVoltage, ifnull(f.IMEINumber,''), f.SIMNumber, f.ServiceProviderId, f.ServiceProvider, f.IsDataTransmitted, f.AWSLatitude, f.AWSLongitude, f.AWSAccuracy, f.PropertyId, f.Property, f.HostPaymentPaidUpto, f.Comments, f.CreateBy, f.CreateDate, f.AnyFaultyComponentId, f.SensorId, rc.RevenueCircleName, (CASE WHEN f.PanchayatId = '99999' THEN 'Others' ELSE pc.PanchayatName END), ifnull(f.PanchayatName,''), (CASE WHEN f.VillageId = '99999' THEN 'Others' ELSE vl.VillageName END), ifnull(f.VillageName,'') FROM AWSMaintenanceForm f  LEFT OUTER JOIN Panchayat pc ON f.PanchayatId = pc.PanchayatId LEFT OUTER JOIN Village vl ON f.VillageId = vl.VillageId,RevenueCircle rc WHERE f.UniqueId = '" + uniqueId + "' AND f.isTemp ='0' AND f.RevenueCircleId = rc.RevenueCircleId";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            ...
            form.add(cursor.getString(35));
            form.add(cursor.getString(36));
            form.add(cursor.getString(37));
            form.add(cursor.getString(38));
            form.add(cursor.getString(39));
            form.add(cursor.getString(40));
            form.add(cursor.getString(41));
            form.add(cursor.getString(42));
            form.add(cursor.getString(43));
        }
        cursor.close();
    ...
    public ArrayList<HashMap<String, String>> getAWSMaintenanceSummaryData() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT DISTINCT frm.UniqueId, frm.State, frm.District, frm.Block,  ifnull(vl.VillageName,frm.VillageName), frm.PurposeOfVisit FROM AWSMaintenanceForm frm LEFT OUTER JOIN Village vl ON frm.VillageId = vl.VillageId WHERE frm.isTemp ='0' ORDER BY LOWER(frm.State), LOWER(frm.District), LOWER(frm.Block), LOWER(ifnull(vl.VillageName,frm.VillageName)), LOWER(frm.PurposeOfVisit)";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
    ...
    public ArrayList<HashMap<String, String>> getSelectedUnSyncAWSMaintenanceForms() {
        ...
        while (cursor.moveToNext()) {
            ...
            map.put("RevenueCircleId", cursor.getString(30));
            map.put("PanchayatId", cursor.getString(31));
            map.put("PanchayatName", cursor.getString(32));
            map.put("VillageId", cursor.getString(33));
            wordList.add(map);
        }
        cursor.close();
        return wordList;
    ...
    //<editor-fold desc="Method to Get All UnSync AWS Maintenance Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncAWSMaintenanceForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.UniqueId, f.StateId, f.DistrictId, f.BlockId, f.VillageName, ifnull(f.BarCodeScan,''), ifnull(f.LastScanDate,''), f.PurposeOfVisitId, ifnull(f.ProblemIdentified,''), f.AnyFaultyComponentId, ifnull(f.ReasonForRelocation,''), f.IsSensorWorking, f.SensorId, f.BatteryVoltage, f.SolarPanelVoltage, ifnull(f.IMEINumber,''), f.SIMNumber, f.ServiceProviderId, f.IsDataTransmitted, f.AWSLatitude, f.AWSLongitude, f.AWSAccuracy, f.PropertyId, f.HostPaymentPaidUpto, f.Comments, f.Latitude, f.Longitude, f.Accuracy, f.CreateBy, f.CreateDate, f.RevenueCircleId, f.PanchayatId, f.PanchayatName, f.VillageId TEXT FROM AWSMaintenanceForm f WHERE f.IsSync IS NULL AND f.isTemp ='0' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync AWS Maintenance Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncAWSMaintenanceImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='AWS Maintenance' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Road Side Crowd Sourcing Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncRoadSideCrowdSourcing() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.UniqueId, f.SurveyDate, f.StateId, f.DistrictId, f.BlockId, f.Village, f.GPSBasedSurvey, f.LeftSideCropId, f.LeftSideCropStageId, f.LeftSideCropCondition, f.RightSideCropId, f.RightSideCropStageId, f.RightSideCropCondition, f.CropId, f.CropStageId, f.CurrentCropCondition, f.LatitudeInside, f.LongitudeInside, f.AccuracyInside, f.Comments, f.Latitude, f.Longitude, f.Accuracy, f.CreateBy, f.CreateDate FROM RoadSideCrowdSourcing f WHERE f.IsSync ='0' AND f.isTemp ='0' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Road Side Crowd Sourcing Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncRoadSideCrowdSourcingImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='RoadSideCrowdSourcing' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Update Road Side Crowd Sourcing Is Sync Flag">
    public String Update_RoadSideCrowdSourcingIsSync() {
        try {
            String query = "DELETE FROM RoadSideCrowdSourcing WHERE isTemp ='0' ";
            db.execSQL(query);
            result = "success";
            return result;
        } catch (Exception e) {
...
//</editor-fold>
    ...
    //<editor-fold desc="Method to Get All UnSync Driage Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncDriageForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.UniqueId, f.SeasonId, f.RandomNo, f.StateId, f.DistrictId, f.BlockId, f.RevenueCircleId, f.PanchayatId, f.PanchayatName, f.VillageId, f.VillageName, f.FarmerName, f.Mobile, f.SurveyDate, f.OfficerName, f.OfficerDesignation, f.OfficerContactNo, f.CropId, f.HighestKhasraSurveyNo, f.CCEPlotKhasraSurveyNo, f.SWCLongitude, f.SWCLatitude, f.SWCAccuracy, f.Type, f.PickingCount, f.PickingWeight, f.BundleWeight, f.DryWeight, f.IsForm2FIlled, f.IsWIttnessFormFilled, f.Comments, f.Latitude, f.Longitude, f.Accuracy, f.CreateDate, f.CreateBy FROM DriageAndPicking f WHERE f.IsSync = '0' AND f.IsTemp = '0' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
    ...
    //<editor-fold desc="Method to Get All UnSync Driage Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncDriageImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId, f.UniqueId, f.PictureUploadId, f.FileName, f.Latitude, f.Longitude, f.Accuracy, f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='Driage Form'  ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("DriageAndroidUniqueId", cursor.getString(0));
...
//</editor-fold>
    ...
    //<editor-fold desc="Method to Get All UnSync AWS Installation Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncAWSInstallation() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.AndroidUniqueId, f.StateId, f.DistrictId, f.BlockId, f.VillageName, f.SurveyDate, f.BarCode, f.HostName, f.HostAddress, f.LandMark, f.MobileNo, f.AWSPropertyId, f.HostBankAccountNo, f.HostAccountHolderName, f.Bank, f.IFSC, f.Branch, f.ATRHSesnorMake , f.ATRHSesnorModel, f.AnemometerMake, f.AnemometerModel, f.RainGaugeSesnorMake, f.RaingaugeSesnorModel, f.DataLoggerMake, f.DataLoggerModel, f.SolarRadiationMake, f.SolarRadiationModel, f.PressureSensorMake, f.PressureSensorModel , f.SoilMoisturesensorMake, f.SoilMoisturesensorModel, f.SoilTemperatureSensorMake, f.SoilTemperatureSensorModel, f.LeafWetnessSensorMake, f.LeafWetnessSensorModel, f.SunShineSensorMake, f.SunShineSensorModel, f.DataLoggerIMEINo , f.SIMNumber, f.ServiceProviderId, f.SDCardStorageMemmory, f.SolarPanelMakePerWatts, f.SolarPanelOutputVoltage, f.BatteryMakeModel, f.BatteryOutputVoltage, f.IsAWSInstalledAsPerGuidelines, f.HeightOfAWSPole, f.IsObstaclesNear , f.AWSObstacleDistance, f.IsDataTransmitted, f.Comments, f.AWSLatitude, f.AWSLongitude, f.AWSAccuracy, f.Latitude, f.Longitude, f.Accuracy, f.AndroidCreateDate FROM AWSInstallationForm f WHERE f.IsSync IS NULL ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("AndroidUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync AWS Maintenance Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncAWSInstallationImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='AWS Installation Form' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Update All AWS Installation Is Sync Flag">
    public String Update_AllAWSInstallationIsSync() {
        try {
            String query = "DELETE FROM AWSInstallationForm ";
            db.execSQL(query);
            result = "success";
            return result;
        } catch (Exception e) {
    ...
    //<editor-fold desc="Method to Get All Trader Field Survey Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncTraderFieldSurvey() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.SeasonId, f.StateId, f.DistrictId, f.BlockId, f.SurveyDate, f.Respondent, f.OtherRespondent, f.RespondentName, f.MobileNo, f.MonsoonOnset, f.RainfallPattern, f.RainInLast15Days, f.RemarksOnRainfallPattern, f.PrimaryCropId, f.PrimaryMajorVarities, f.PrimaryFromSowingDate, f.PrimaryToSowingDate, f.PrimaryFromHarvestDate, f.PrimaryToHarvestDate, f.PrimaryDaysOfOldCrop, CASE WHEN f.PrimaryCropStageId='' THEN 0 ELSE f.PrimaryCropStageId END, f.PrimaryCropCondition, f.PrimaryIsPestAttack, f.PrimaryPestAttackType, CASE WHEN f.PrimaryAverageYield='' THEN 0 ELSE f.PrimaryAverageYield END, CASE WHEN f.PrimaryExpectedYield='' THEN 0 ELSE f.PrimaryExpectedYield END, f.PrimaryRemarks, f.SecondaryCropId, f.SecondaryMajorVarities, f.SecondaryFromSowingDate, f.SecondaryToSowingDate, f.SecondaryFromHarvestDate, f.SecondaryToHarvestDate, f.SecondaryDaysOfOldCrop, CASE WHEN f.SecondaryCropStageId='' THEN 0 ELSE f.SecondaryCropStageId END, f.SecondaryCropCondition, f.SecondaryIsPestAttack, f.SecondaryPestAttackType, CASE WHEN f.SecondaryAverageYield='' THEN 0 ELSE f.SecondaryAverageYield END, CASE WHEN f.SecondaryExpectedYield='' THEN 0 ELSE f.SecondaryExpectedYield END, f.SecondaryRemarks, f.TertiaryCropId, f.TertiaryMajorVarities, f.TertiaryFromSowingDate, f.TertiaryToSowingDate, f.TertiaryFromHarvestDate, f.TertiaryToHarvestDate, f.TertiaryDaysOfOldCrop, CASE WHEN f.TertiaryCropStageId='' THEN 0 ELSE f.TertiaryCropStageId END, f.TertiaryCropCondition, f.TertiaryIsPestAttack, f.TertiaryPestAttackType, CASE WHEN f.TertiaryAverageYield='' THEN 0 ELSE f.TertiaryAverageYield END, CASE WHEN f.TertiaryExpectedYield='' THEN 0 ELSE f.TertiaryExpectedYield END, f.TertiaryRemarks, f.GPSLatitude, f.GPSLongitude, f.GPSAccuracy, f.IsCropRiskInBlock, f.CropRiskTaluka, f.CropRiskBlock, CASE WHEN f.AbioticPercentage='' THEN 0 ELSE f.AbioticPercentage END, CASE WHEN f.BioticPercentage='' THEN 0 ELSE f.BioticPercentage END, f.Latitude, f.Longitude, f.Accuracy, f.UniqueId, f.CreateDate, f.CreateBy, f.CropRiskRemarks, f.MultipleCropId, f.MultipleAbiotic, f.MultipleBiotic FROM TraderFieldSurvey f WHERE f.IsTemp = '0' AND f.IsSync = '0' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("SeasonId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Trader Field Survey Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncTraderFieldSurveyImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='TraderFieldSurvey' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Update Trader Field Survey Is Sync Flag">
    public String Update_TraderFieldSurveyIsSync() {
        try {
            String query = "DELETE FROM TraderFieldSurvey  ";
            db.execSQL(query);
            result = "success";
            return result;
        } catch (Exception e) {
    ...
    //<editor-fold desc="Methods Used in Insured Crop Verification Form">
    //<editor-fold desc="Code to check if data exists in temporary table for Insured Crop Verification">
    public boolean isTemporaryInsuredDataAvailable() {
        boolean isAvailable = false;
        int existCount;
        selectQuery = "SELECT * FROM InsuredCropVerificationFormTemp";
        cursor = db.rawQuery(selectQuery, null);
        existCount = cursor.getCount();
        cursor.close();
    ...
    //<editor-fold desc="Code to get Insured Crop Verification Form Detail from temp table">
    public ArrayList<String> getInsuredFormTempDetails() {
        ArrayList<String> issueformdetails = new ArrayList<>();

        selectQuery = "SELECT ApplicationNumber,SeasonId,StateId,DistrictId,BlockId,RevenueCircleId, PanchayatId,ifnull(PanchayatName,''),PanchayatMasterStatus,VillageId,ifnull(VillageName,''),VillageMasterStatus,IsFarmerAvailable,FarmerName,MobileNo,FarmerType,ifnull(CropId,''), CropOnField, ifnull(Irrigation,''), ifnull(SurveyKhasraNo,''),ifnull(SubSurveyNo,''),ifnull(HissaNumber,''),LandUnits,ifnull(SowingArea,''),ifnull(CropPatternId,''),ifnull(CropName,''),SurveyDate,Comments,ifnull(Latitude,''), ifnull(Longitude,''), ifnull(Accuracy,''),AndroidUniqueId,AndroidCreateDate,CreateBy,CreateMachine,InsuredLatitude,InsuredLongitude,InsuredAccuracy FROM InsuredCropVerificationFormTemp";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            issueformdetails.add(cursor.getString(0));
            issueformdetails.add(cursor.getString(1));
            issueformdetails.add(cursor.getString(2));
            issueformdetails.add(cursor.getString(3));
            issueformdetails.add(cursor.getString(4));
            issueformdetails.add(cursor.getString(5));
            issueformdetails.add(cursor.getString(6));
            issueformdetails.add(cursor.getString(7));
            issueformdetails.add(cursor.getString(8));
            issueformdetails.add(cursor.getString(9));
            issueformdetails.add(cursor.getString(10));
            issueformdetails.add(cursor.getString(11));
            issueformdetails.add(cursor.getString(12));
            issueformdetails.add(cursor.getString(13));
            issueformdetails.add(cursor.getString(14));
            issueformdetails.add(cursor.getString(15));
            issueformdetails.add(cursor.getString(16));
            issueformdetails.add(cursor.getString(17));
            issueformdetails.add(cursor.getString(18));
            issueformdetails.add(cursor.getString(19));
            issueformdetails.add(cursor.getString(20));
            issueformdetails.add(cursor.getString(21));
            issueformdetails.add(cursor.getString(22));
            issueformdetails.add(cursor.getString(23));
            issueformdetails.add(cursor.getString(24));
            issueformdetails.add(cursor.getString(25));
            issueformdetails.add(cursor.getString(26));
            issueformdetails.add(cursor.getString(27));
            issueformdetails.add(cursor.getString(28));
            issueformdetails.add(cursor.getString(29));
            issueformdetails.add(cursor.getString(30));
            issueformdetails.add(cursor.getString(31));
            issueformdetails.add(cursor.getString(32));
            issueformdetails.add(cursor.getString(33));
            issueformdetails.add(cursor.getString(34));
            issueformdetails.add(cursor.getString(35));
            issueformdetails.add(cursor.getString(36));
            issueformdetails.add(cursor.getString(37));
        }
        cursor.close();

        return issueformdetails;
    }
    //</editor-fold>

    //<editor-fold desc="Code to Insert Data in InsuredCropVerificationFormTemp Table">
    public String Insert_InsuredCropVerificationFormTemp(String ApplicationNumber, String SeasonId, String StateId, String DistrictId, String BlockId, String RevenueCircleId, String PanchayatId, String PanchayatName, String VillageId, String VillageName, String IsFarmerAvailable, String FarmerName, String MobileNo, String FarmerType, String CropId, String CropOnField, String Irrigation, String SurveyKhasraNo, String SubSurveyNo, String HissaNumber, String LandUnits, String SowingArea, String CropPatternId, String CropName, String SurveyDate, String Comments, String AndroidUniqueId, String InsuredLatitude, String InsuredLongitude, String InsuredAccuracy, String SearchId) {
        try {

            int existCount;

            selectQuery = "SELECT * FROM InsuredCropVerificationFormTemp WHERE AndroidUniqueId = '" + AndroidUniqueId + "'";
            cursor = db.rawQuery(selectQuery, null);
            existCount = cursor.getCount();
            cursor.close();
            ...
            if (existCount == 0) {
                ...
                newValues.put("FarmerType", FarmerType);
                newValues.put("CropId", CropId);
                newValues.put("CropOnField", CropOnField);
                newValues.put("Irrigation", Irrigation);
                newValues.put("SurveyKhasraNo", SurveyKhasraNo);
                newValues.put("SubSurveyNo", SubSurveyNo);
                newValues.put("HissaNumber", HissaNumber);
                newValues.put("LandUnits", LandUnits);
                newValues.put("SowingArea", SowingArea);
                newValues.put("CropPatternId", CropPatternId);
                newValues.put("CropName", CropName);
                newValues.put("SurveyDate", SurveyDate);
                newValues.put("Comments", Comments);
                newValues.put("AndroidUniqueId", AndroidUniqueId);
                newValues.put("InsuredLatitude", InsuredLatitude);
                newValues.put("InsuredLongitude", InsuredLongitude);
                newValues.put("InsuredAccuracy", InsuredAccuracy);
                newValues.put("SearchId", SearchId);
                db.insert("InsuredCropVerificationFormTemp", null, newValues);


            } else {
                db.execSQL("UPDATE InsuredCropVerificationFormTemp SET ApplicationNumber='" + ApplicationNumber + "',SeasonId='" + SeasonId + "',StateId='" + StateId + "',DistrictId='" + DistrictId + "',BlockId='" + BlockId + "',RevenueCircleId='" + RevenueCircleId + "', PanchayatId='" + PanchayatId + "',PanchayatName='" + PanchayatName + "',VillageId='" + VillageId + "',VillageName='" + VillageName + "',IsFarmerAvailable='" + IsFarmerAvailable + "',FarmerName='" + FarmerName + "',MobileNo='" + MobileNo + "',FarmerType='" + FarmerType + "',CropId='" + CropId + "', CropOnField='" + CropOnField + "', Irrigation='" + Irrigation + "', SurveyKhasraNo='" + SurveyKhasraNo + "',SubSurveyNo='" + SubSurveyNo + "',HissaNumber='" + HissaNumber + "',LandUnits='" + LandUnits + "',SowingArea='" + SowingArea + "',CropPatternId='" + CropPatternId + "',CropName='" + CropName + "',SurveyDate='" + SurveyDate + "',Comments='" + Comments + "',InsuredLatitude='" + InsuredLatitude + "',InsuredLongitude='" + InsuredLongitude + "',InsuredAccuracy='" + InsuredAccuracy + "', SearchId='" + SearchId + "' WHERE AndroidUniqueId = '" + AndroidUniqueId + "' ");
            }
            result = "success";
            return result;
        } catch (Exception e) {
    ...
    //<editor-fold desc="Method to get Insured Crop Verification Form Detail by UniqueId">
    public ArrayList<String> getInsuredVerificationByUniqueId(String uniqueId, String isTemp) {
        ArrayList<String> issueformdetails = new ArrayList<>();
        if (isTemp.equalsIgnoreCase("1"))
            selectQuery = "SELECT ApplicationNumber,SeasonId,StateId,DistrictId,BlockId,RevenueCircleId, PanchayatId,ifnull(PanchayatName,''),PanchayatMasterStatus,VillageId,ifnull(VillageName,''),VillageMasterStatus,IsFarmerAvailable,FarmerName,MobileNo,FarmerType,ifnull(CropId,''), CropOnField, ifnull(Irrigation,''), ifnull(SurveyKhasraNo,''),ifnull(SubSurveyNo,''),ifnull(HissaNumber,''),LandUnits,ifnull(SowingArea,''),ifnull(CropPatternId,''),ifnull(CropName,''),SurveyDate,Comments,ifnull(Latitude,''), ifnull(Longitude,''), ifnull(Accuracy,''),AndroidUniqueId,AndroidCreateDate,CreateBy,CreateMachine,InsuredLatitude,InsuredLongitude,InsuredAccuracy, SearchId FROM InsuredCropVerificationFormTemp";
        else
            selectQuery = "SELECT ApplicationNumber,SeasonId,StateId,DistrictId,BlockId,RevenueCircleId, PanchayatId,ifnull(PanchayatName,''),PanchayatMasterStatus,VillageId,ifnull(VillageName,''),VillageMasterStatus,IsFarmerAvailable,FarmerName,MobileNo,FarmerType,ifnull(CropId,''), CropOnField, ifnull(Irrigation,''), ifnull(SurveyKhasraNo,''),ifnull(SubSurveyNo,''),ifnull(HissaNumber,''),LandUnits,ifnull(SowingArea,''),ifnull(CropPatternId,''),ifnull(CropName,''),SurveyDate,Comments,ifnull(Latitude,''), ifnull(Longitude,''), ifnull(Accuracy,''),AndroidUniqueId,AndroidCreateDate,CreateBy,CreateMachine,InsuredLatitude,InsuredLongitude,InsuredAccuracy, SearchId FROM InsuredCropVerificationFormTemp WHERE AndroidUniqueId = '" + uniqueId + "'";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            issueformdetails.add(cursor.getString(0));
            issueformdetails.add(cursor.getString(1));
            ...
            issueformdetails.add(cursor.getString(36));
            issueformdetails.add(cursor.getString(37));
            issueformdetails.add(cursor.getString(38));
        }
        cursor.close();
        return issueformdetails;
    }
    ...
    //<editor-fold desc="Method to insert Data  InsuredCropVerificationForm and CCEMFormDocument from Temporary Table Table">
    public String Insert_InsuredCropVerificationForm(String uniqueId, String latitude, String longitude, String accuracy, String userId, String machine) {
        try {
            db.execSQL("INSERT INTO InsuredCropVerificationForm(ApplicationNumber,SeasonId,StateId,DistrictId,BlockId,RevenueCircleId, PanchayatId,PanchayatName,PanchayatMasterStatus,VillageId,VillageName,VillageMasterStatus,IsFarmerAvailable,FarmerName,MobileNo,FarmerType,CropId, CropOnField, Irrigation, SurveyKhasraNo,SubSurveyNo,HissaNumber,LandUnits,SowingArea,CropPatternId,CropName,SurveyDate,Comments,Latitude,Longitude,Accuracy,AndroidUniqueId,AndroidCreateDate,CreateBy,CreateMachine,InsuredLatitude,InsuredLongitude,InsuredAccuracy, SearchId) SELECT ApplicationNumber,SeasonId,StateId,DistrictId,BlockId,RevenueCircleId, PanchayatId,PanchayatName,PanchayatMasterStatus,VillageId,VillageName,VillageMasterStatus,IsFarmerAvailable,FarmerName,MobileNo,FarmerType,CropId, CropOnField, Irrigation, SurveyKhasraNo,SubSurveyNo,HissaNumber,LandUnits,SowingArea,CropPatternId,CropName,SurveyDate,Comments,'" + latitude + "','" + longitude + "', '" + accuracy + "',AndroidUniqueId, '" + getDateTime() + "','" + userId + "','" + machine + "',InsuredLatitude,InsuredLongitude,InsuredAccuracy, SearchId  FROM InsuredCropVerificationFormTemp WHERE AndroidUniqueId = '" + uniqueId + "' ");
            db.execSQL("INSERT INTO CCEMFormDocument(UniqueId,FormType,FormUniqueId,PictureUploadId,FileName,Latitude,Longitude,Accuracy,AttachmentDate,CreateBy) SELECT UniqueId,FormType,FormUniqueId,PictureUploadId,FileName,Latitude,Longitude,Accuracy,AttachmentDate,CreateBy FROM CCEMFormTempDocument WHERE FormUniqueId= '" + uniqueId + "' ");
            db.execSQL("DELETE FROM InsuredCropVerificationFormTemp WHERE AndroidUniqueId = '" + uniqueId + "' ");
            db.execSQL("DELETE FROM CCEMFormTempDocument WHERE FormUniqueId= '" + uniqueId + "' ");
            result = "success";
            return result;
        } catch (Exception e) {
    ...
    //<editor-fold desc="Method to Get Summary Data for InsuredCropVerification Form">
    public ArrayList<HashMap<String, String>> getInsuredCropVerificationFormSumaryData() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT DISTINCT frm.AndroidUniqueId,frm.ApplicationNumber, sm.Season||'-'||sm.Year, cr.CropName, frm.FarmerName, frm.MobileNo, frm.SurveyDate, frm.SurveyKhasraNo FROM InsuredCropVerificationForm frm, SeasonMaster sm, Crop cr WHERE frm.SeasonId = sm.Id AND frm.CropId = cr.CropId  ORDER BY frm.SurveyDate ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
            ...
            map.put("MobileNo", cursor.getString(5));
            map.put("SurveyDate", cursor.getString(6));
            map.put("SurveyKhasraNo", cursor.getString(7));
            list.add(map);
        }
        cursor.close();
        return list;
    ...
    //<editor-fold desc="Method to Get Summary Data from Search Data of InsuredCropVerification Form">
    public ArrayList<HashMap<String, String>> getInsuredCropVerificationFormSearchData() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT DISTINCT tmp.SearchId, tmp.ApplicationNumber, tmp.SeasonName, tmp.CropTitle, tmp.FarmerName, tmp.SurveyKhasraNo FROM InsuredCropVerificationFormSearchTemp tmp LEFT OUTER JOIN InsuredCropVerificationForm main ON tmp.SearchId = main.SearchId WHERE main.AndroidUniqueId IS NULL ORDER BY tmp.ApplicationNumber ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("SearchId", cursor.getString(0));
            ...
            map.put("Crop", cursor.getString(3));
            map.put("FarmerName", cursor.getString(4));
            map.put("SurveyKhasraNo", cursor.getString(5));
            list.add(map);
        }
        cursor.close();
        return list;
    ...
    //<editor-fold desc="Code to get InsuredCropVerification Form Detail from CCEM table by UniqueId">
    public ArrayList<String> getInsuredCropVerificationDetails(String uniqueId) {
        ArrayList<String> insuredformDetails = new ArrayList<String>();
        selectQuery = "SELECT DISTINCT frm.AndroidUniqueId, frm.SurveyDate,sm.Season||'-'||sm.Year, frm.ApplicationNumber, st.StateName, dst.DistrictName, bk.BlockName, rc.RevenueCircleName," +
                " (CASE WHEN frm.PanchayatId = '99999' THEN 'Others' ELSE pc.PanchayatName END), ifnull(frm.PanchayatName,''), " +
                " (CASE WHEN frm.VillageId = '99999' THEN 'Others' ELSE vl.VillageName END), ifnull(frm.VillageName,''), frm.IsFarmerAvailable," +
                " frm.FarmerName, frm.MobileNo,frm.FarmerType,cr.CropName, IFNULL(onf.CropName,''),frm.Irrigation,frm.SurveyKhasraNo, frm.SubSurveyNo, frm.HissaNumber, lu.Name, frm.SowingArea,cp.Name,ifnull(frm.CropName,''),ifnull(frm.Comments,'')," +
                " ifnull(frm.InsuredLongitude,''), ifnull(frm.InsuredLatitude,''), ifnull(frm.InsuredAccuracy,'') " +
                " FROM InsuredCropVerificationForm frm LEFT OUTER JOIN Panchayat pc ON frm.PanchayatId = pc.PanchayatId " +
                " LEFT OUTER JOIN Village vl ON frm.VillageId = vl.VillageId " +
                " LEFT OUTER JOIN Crop onf ON frm.CropOnField = onf.CropId, State st, District dst, Block bk, RevenueCircle rc, SeasonMaster sm, Crop cr, " +
                " LandUnit lu, CropPattern cp  WHERE frm.AndroidUniqueId ='" + uniqueId + "' AND frm.StateId = st.StateId AND frm.DistrictId = dst.DistrictId " +
                " AND frm.BlockId = bk.BlockId AND frm.RevenueCircleId = rc.RevenueCircleId AND frm.SeasonId = sm.Id AND frm.CropId = cr.CropId AND frm.LandUnits = lu.Id " +
                " AND frm.CropPatternId =cp.Id ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            insuredformDetails.add(cursor.getString(0));
            insuredformDetails.add(cursor.getString(1));
            insuredformDetails.add(cursor.getString(2));
            insuredformDetails.add(cursor.getString(3));
            insuredformDetails.add(cursor.getString(4));
            insuredformDetails.add(cursor.getString(5));
            insuredformDetails.add(cursor.getString(6));
            insuredformDetails.add(cursor.getString(7));
            insuredformDetails.add(cursor.getString(8));
            insuredformDetails.add(cursor.getString(9));
            insuredformDetails.add(cursor.getString(10));
            insuredformDetails.add(cursor.getString(11));
            insuredformDetails.add(cursor.getString(12));
            insuredformDetails.add(cursor.getString(13));
            insuredformDetails.add(cursor.getString(14));
            insuredformDetails.add(cursor.getString(15));
            insuredformDetails.add(cursor.getString(16));
            insuredformDetails.add(cursor.getString(17));
            insuredformDetails.add(cursor.getString(18));
            insuredformDetails.add(cursor.getString(19));
            insuredformDetails.add(cursor.getString(20));
            insuredformDetails.add(cursor.getString(21));
            insuredformDetails.add(cursor.getString(22));
            insuredformDetails.add(cursor.getString(23));
            insuredformDetails.add(cursor.getString(24));
            insuredformDetails.add(cursor.getString(25));
            insuredformDetails.add(cursor.getString(26));
            insuredformDetails.add(cursor.getString(27));
            insuredformDetails.add(cursor.getString(28));
        }
        cursor.close();

        return insuredformDetails;
    }
    //</editor-fold>

    //<editor-fold desc="Method to Get Selected UnSync Crop Verification Forms">
    public ArrayList<HashMap<String, String>> getSelectedUnSyncInsuredCropVerificationForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.ApplicationNumber, f.SeasonId, f.StateId, f.DistrictId, f.BlockId, f.RevenueCircleId, f.PanchayatId, IFNULL(f.PanchayatName,''),f.VillageId, IFNULL(f.VillageName,''),f.IsFarmerAvailable, f.FarmerName, f.MobileNo, f.FarmerType, f.CropId, f.CropOnField, f.Irrigation, f.SurveyKhasraNo, f.SubSurveyNo, f.HissaNumber, f.LandUnits, f.SowingArea, f.CropPatternId, f.CropName, f.SurveyDate, f.Comments, f.Latitude, f.Longitude, f.Accuracy, f.InsuredLatitude, f.InsuredLongitude, f.InsuredAccuracy, f.AndroidUniqueId, f.AndroidCreateDate, f.CreateBy, f.CreateMachine, f.SearchId FROM InsuredCropVerificationForm f, SelectedSyncData s WHERE f.IsSync IS NULL AND f.AndroidUniqueId = s.FormId AND s.FormName = 'Insured Crop Verification Form' AND s.IsSync IS NULL";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("ApplicationNumber", cursor.getString(0));
            map.put("SeasonId", cursor.getString(1));
            map.put("StateId", cursor.getString(2));
            map.put("DistrictId", cursor.getString(3));
            map.put("BlockId", cursor.getString(4));
            ...
            map.put("VillageId", cursor.getString(8));
            map.put("VillageName", cursor.getString(9));
            map.put("IsFarmerAvailable", cursor.getString(10));
            map.put("FarmerName", cursor.getString(11));
            map.put("MobileNo", cursor.getString(12));
            map.put("FarmerType", cursor.getString(13));
            map.put("CropId", cursor.getString(14));
            map.put("CropOnField", cursor.getString(15));
            map.put("Irrigation", cursor.getString(16));
            map.put("SurveyKhasraNo", cursor.getString(17));
            map.put("SubSurveyNo", cursor.getString(18));
            map.put("HissaNumber", cursor.getString(19));
            map.put("LandUnits", cursor.getString(20));
            map.put("SowingArea", cursor.getString(21));
            map.put("CropPatternId", cursor.getString(22));
            map.put("CropName", cursor.getString(23));
            map.put("SurveyDate", cursor.getString(24));
            map.put("Comments", cursor.getString(25));
            map.put("Latitude", cursor.getString(26));
            map.put("Longitude", cursor.getString(27));
            map.put("Accuracy", cursor.getString(28));
            map.put("InsuredLatitude", cursor.getString(29));
            map.put("InsuredLongitude", cursor.getString(30));
            map.put("InsuredAccuracy", cursor.getString(31));
            map.put("AndroidUniqueId", cursor.getString(32));
            map.put("AndroidCreateDate", cursor.getString(33));
            map.put("CreateBy", cursor.getString(34));
            map.put("CreateMachine", cursor.getString(35));
            map.put("SearchId", cursor.getString(36));
            wordList.add(map);
        }
        cursor.close();
        return wordList;
    ...
    //<editor-fold desc="Method to Get All UnSync Crop Verification Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncInsuredCropVerificationForm() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.ApplicationNumber, f.SeasonId, f.StateId, f.DistrictId, f.BlockId, f.RevenueCircleId, f.PanchayatId, IFNULL(f.PanchayatName,''),f.VillageId, IFNULL(f.VillageName,''),f.IsFarmerAvailable, f.FarmerName, f.MobileNo, f.FarmerType, f.CropId, f.CropOnField, f.Irrigation, f.SurveyKhasraNo, f.SubSurveyNo, f.HissaNumber, f.LandUnits, f.SowingArea, f.CropPatternId, f.CropName, f.SurveyDate, f.Comments, f.Latitude, f.Longitude, f.Accuracy, f.InsuredLatitude, f.InsuredLongitude, f.InsuredAccuracy, f.AndroidUniqueId, f.AndroidCreateDate, f.CreateBy, f.CreateMachine, f.SearchId FROM InsuredCropVerificationForm f WHERE f.IsSync IS NULL ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("ApplicationNumber", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get Selected UnSync Insured Crop Verification Form Images">
    public ArrayList<HashMap<String, String>> getSelectedUnSyncInsuredCropVerificationImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f, SelectedSyncData s WHERE f.FormType ='InsuredCropVerificationForm'  AND f.FormUniqueId = s.FormId AND s.FormName = 'Insured Crop Verification Form' AND s.IsSync IS NULL";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Method to Get All UnSync Insured Crop Verification Form Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncInsuredCropVerificationImage() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='InsuredCropVerificationForm'  ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("CCEAndroidnUniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Update Selected InsuredCropVerification Is Sync Flag">
    public String Update_SelectedInsuredCropVerificationIsSync() {
        try {
            db.execSQL("UPDATE SelectedSyncData SET IsSync = '1' WHERE FormName = 'Insured Crop Verification Form' ");
            String query = "DELETE FROM InsuredCropVerificationForm WHERE AndroidUniqueId IN (SELECT FormId FROM SelectedSyncData WHERE FormName = 'Insured Crop Verification Form' AND IsSync ='1') ";
            db.execSQL(query);
            result = "success";
            return result;
        } catch (Exception e) {
    ...
    //<editor-fold desc="Method to Get All UnSync Crop Verification Forms">
    public ArrayList<HashMap<String, String>> getAllUnSyncInsuredCropVerificationForms() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.ApplicationNumber, f.SeasonId, f.StateId, f.DistrictId, f.BlockId, f.RevenueCircleId, f.PanchayatId, IFNULL(f.PanchayatName,''),f.VillageId, IFNULL(f.VillageName,''),f.IsFarmerAvailable, f.FarmerName, f.MobileNo, f.FarmerType, f.CropId, f.CropOnField, f.Irrigation, f.SurveyKhasraNo, f.SubSurveyNo, f.HissaNumber, f.LandUnits, f.SowingArea, f.CropPatternId, f.CropName, f.SurveyDate, f.Comments, f.Latitude, f.Longitude, f.Accuracy, f.InsuredLatitude, f.InsuredLongitude, f.InsuredAccuracy, f.AndroidUniqueId, f.AndroidCreateDate, f.CreateBy, f.CreateMachine, f.SearchId FROM InsuredCropVerificationForm f WHERE f.IsSync IS NULL";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
    ...
    //<editor-fold desc="Method to Get All UnSync Insured Crop Verification Form Images">
    public ArrayList<HashMap<String, String>> getAllUnSyncInsuredCropVerificationImages() {
        ArrayList<HashMap<String, String>> wordList = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT f.FormUniqueId,f.UniqueId,f.PictureUploadId,f.FileName,f.Latitude,f.Longitude,f.Accuracy,f.AttachmentDate FROM CCEMFormDocument f WHERE f.FormType ='InsuredCropVerificationForm' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
    ...
    //<editor-fold desc="Update Insured Crop Verification Is Sync Flag">
    public String Update_InsuredCropVerificationIsSync() {
        try {
            String query = "DELETE FROM InsuredCropVerificationForm";
            db.execSQL(query);
            result = "success";
            return result;
        } catch (Exception e) {
    ...
    //<editor-fold desc="Update Selected Insured Form Is Sync Flag">
    public String Update_SelectedInsuredFormIsSync() {
        try {
    ...
    //<editor-fold desc="Code to Insert Data in InsuredCropVerificationFormSearchTemp Table">
    public String Insert_InsuredCropVerificationFormSearchTemp(String SearchId, String ApplicationNumber, String SeasonId, String SeasonName, String StateId, String StateName, String DistrictId, String DistrictName, String BlockId, String BlockName, String RevenueCircleId, String RevenueCircle, String PanchayatId, String PanchayatName, String VillageId, String VillageName, String FarmerName, String MobileNo, String FarmerType, String CropId, String CropTitle, String Irrigation, String SurveyKhasraNo, String SubSurveyNo, String HissaNumber, String InsuredArea) {
        ...
        try {
            ...
            newValues.put("FarmerType", FarmerType);
            newValues.put("CropId", CropId);
            newValues.put("CropTitle", CropTitle);
            newValues.put("Irrigation", Irrigation);
            newValues.put("SurveyKhasraNo", SurveyKhasraNo);
            newValues.put("SubSurveyNo", SubSurveyNo);
            newValues.put("HissaNumber", HissaNumber);
            newValues.put("InsuredArea", InsuredArea);
            db.insert("InsuredCropVerificationFormSearchTemp", null, newValues);
            result = "success";
            return result;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    //<editor-fold desc="Code to get InsuredCropVerification Form Detail From SearchResult">
    public ArrayList<String> getInsuredCropVerificationSearchDetails(String id) {
        ArrayList<String> insuredformDetails = new ArrayList<String>();
        selectQuery = "SELECT DISTINCT SearchId, ApplicationNumber, SeasonId, SeasonName, StateId, StateName, DistrictId, DistrictName, BlockId, BlockName, RevenueCircleId, RevenueCircle, PanchayatId, PanchayatName, VillageId, VillageName, FarmerName, MobileNo, FarmerType, CropId, CropTitle, Irrigation, SurveyKhasraNo, SubSurveyNo, HissaNumber, InsuredArea " +
                " FROM InsuredCropVerificationFormSearchTemp " +
                " WHERE SearchId ='" + id + "' ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            insuredformDetails.add(cursor.getString(0));
    ...
    //<editor-fold desc="Code to check if Geo Tags is already added for Loss Assessment">
    public String isMultiPickingCrop(String cropId) {
        int isMultipickingCrop = 0;
        selectQuery = "SELECT CropId FROM Crop WHERE IsMultiPicking='1' AND CropId='" + cropId + "' ";
        cursor = db.rawQuery(selectQuery, null);

        if (cursor.getCount() > 0) {
            isMultipickingCrop = 1;
        }
        cursor.close();
        return String.valueOf(isMultipickingCrop);
    }
    //</editor-fold>

    //<editor-fold desc="Methods Used in New CCE Form">
    //<editor-fold desc="GetIrrigationSource for NEW CCE from Temp Table">
    public List<CustomType> GetCCEIrrigationSource(String uniqueId) {
        List<CustomType> labels = new ArrayList<CustomType>();
        selectQuery = "SELECT DISTINCT s.IrrigationSourceId||'!'||IFNULL(cs.irrigationSourceId,''), s.IrrigationSourceName FROM IrrigationSource s LEFT OUTER JOIN NEWCCEFormTemp cs ON cs.AndroidUniqueId ='" + uniqueId + "' ORDER BY s.IrrigationSourceName COLLATE NOCASE ASC";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            labels.add(new CustomType(cursor.getString(0), cursor.getString(1)));
        }
    ...
    //<editor-fold desc="Code to Insert Data in New CCE Form Temp Table">
    public String Insert_NEWCCEFormTemp(String uniqueId, String seasonId, String seasonName, String cceType, String cropId, String cropName, String pickingType, String cropSurveyFormId, String ccemSurveyFormId, String surveyDate) {
        try {
            ...
            newValues.put("SeasonId", seasonId);
            newValues.put("SeasonName", seasonName);
            newValues.put("CCEType", cceType);
            newValues.put("CropId", cropId);
            newValues.put("CropName", cropName);
            newValues.put("PickingType", pickingType);
            newValues.put("CropSurveyFormId", cropSurveyFormId);
            newValues.put("CCEMSurveyFormId", ccemSurveyFormId);
            newValues.put("SurveyDate", surveyDate);
            newValues.put("AndroidCreateDate", getDateTime());

            db.insert("NEWCCEFormTemp", null, newValues);
            result = "success";
            return result;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    //<editor-fold desc="Code to Delete data from NEWCCEFormTemp Table">
    public String DeleteNEWCCEFormTemp() {
        result = "fail";
        try {
            newValues = new ContentValues();
            db.execSQL("DELETE FROM NEWCCEFormTemp");
            result = "success";
        } catch (Exception e) {
            e.printStackTrace();
            return null;
    ...
    //<editor-fold desc="Method to Get Search Data NEW CCE Temp data for Display by UniqueId">
    public ArrayList<HashMap<String, String>> getSearchDataForNEWCCEFormTemp(String uniqueId) {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();

        selectQuery = "SELECT AndroidUniqueId,SeasonId,SeasonName,CCEType,CropId,CropName,PickingType,CropSurveyFormId,CCEMSurveyFormId,SurveyDate,StateId FROM NEWCCEFormTemp WHERE AndroidUniqueId ='" + uniqueId + "'";
        ...
        while (cursor.moveToNext()) {
            ...
            map.put("UniqueId", cursor.getString(0));
            map.put("SeasonId", cursor.getString(1));
            map.put("SeasonName", cursor.getString(2));
            map.put("CCEType", cursor.getString(3));
            map.put("CropId", cursor.getString(4));
            map.put("CropName", cursor.getString(5));
            map.put("PickingType", cursor.getString(6));
            map.put("CropSurveyFormId", cursor.getString(7));
            map.put("CCEMSurveyFormId", cursor.getString(8));
            map.put("SurveyDate", cursor.getString(9));
            map.put("StateId", cursor.getString(10));
            list.add(map);
        }
        cursor.close();
        return list;
    ...
    //<editor-fold desc="Code to Update Data in New CCE Form Temp Table">
    public String Update_NEWCCEFormTemp(String uniqueId, String StateId, String StateName, String DistrictId, String DistrictName, String BlockId, String BlockName, String RevenueCircleId, String RevenueCircleName, String PanchayatId, String PanchayatName, String VillageId, String VillageName, String FarmerName, String MobileNo, String Irrigation, String IrrigationSourceId, String IrrigationSource, String SeedCompanyName, String CropVarietyId, String CropVariety, String SowingArea, String KhasraSurveyCCEPlotNo) {
        try {

            db.execSQL("UPDATE NEWCCEFormTemp SET StateId='" + StateId + "',StateName='" + StateName + "',DistrictId='" + DistrictId + "',DistrictName='" + DistrictName + "',BlockId='" + BlockId + "',BlockName='" + BlockName + "',RevenueCircleId='" + RevenueCircleId + "',RevenueCircleName='" + RevenueCircleName + "',PanchayatId='" + PanchayatId + "',PanchayatName='" + PanchayatName + "',VillageId='" + VillageId + "',VillageName='" + VillageName + "',FarmerName='" + FarmerName + "',MobileNo='" + MobileNo + "',Irrigation='" + Irrigation + "',IrrigationSourceId='" + IrrigationSourceId + "',IrrigationSource='" + IrrigationSource + "',SeedCompanyName='" + SeedCompanyName + "',CropVarietyId='" + CropVarietyId + "',CropVariety='" + CropVariety + "',SowingArea='" + SowingArea + "',KhasraSurveyCCEPlotNo='" + KhasraSurveyCCEPlotNo + "' WHERE AndroidUniqueId = '" + uniqueId + "' ");
    ...
    //<editor-fold desc="Method to insert File Data in NEWCCEFormTempDocument Table">
    public String Insert_NEWCCEFormTempDocument(String uniqueId, String formType, String formUniqueId, String pictureUploadId, String fileName, String latitude, String longitude, String accuracy, String createBy) {
        try {
            result = "fail";
            newValues = new ContentValues();
            newValues.put("UniqueId", uniqueId);
            ...
            db.insert("NewCCEFormTempDocument", null, newValues);
            result = "success";
            return result;
        } catch (Exception e) {
            //e.printStackTrace();
    ...
    //<editor-fold desc="Method to Get Uploaded Documents from TemporaryTable by Survey UniqueId">
    public ArrayList<HashMap<String, String>> GetNewCCETempUploadedDocBySurveyUniqueId(String surveyUniqueId) {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();
        selectQuery = "SELECT tdoc.UniqueId, pu.Name, tdoc.FileName FROM NewCCEFormTempDocument tdoc, SurveyFormPictureUpload pu WHERE tdoc.PictureUploadId = pu.Id AND tdoc.FormUniqueId ='" + surveyUniqueId + "' ORDER BY pu.Name COLLATE NOCASE ASC ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
    ...
    //<editor-fold desc="Code to count of files Uploaded">
    public String GetNewCCEFileUploadedCount(String formUniqueId) {
        String fileCount = "";

        selectQuery = "SELECT COUNT(*) FROM NewCCEFormTempDocument WHERE FormUniqueId ='" + formUniqueId + "'";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            fileCount = cursor.getString(0);
        }
    ...
    //<editor-fold desc="Method to insert Data  New CCE Form Table">
    public String Insert_NewCCEFormDocument(String uniqueId, String latitude, String longitude, String accuracy, String userId) {
        try {
            db.execSQL("INSERT INTO CCEMFormDocument(UniqueId,FormType,FormUniqueId,PictureUploadId,FileName,Latitude,Longitude,Accuracy,AttachmentDate,CreateBy) SELECT UniqueId,FormType,FormUniqueId,PictureUploadId,FileName,Latitude,Longitude,Accuracy,AttachmentDate,CreateBy FROM LossAssessmentFormTempDocument WHERE FormUniqueId= '" + uniqueId + "' ");
            db.execSQL("INSERT INTO CCEMFormDocument(UniqueId,FormType,FormUniqueId,PictureUploadId,FileName,Latitude,Longitude,Accuracy,AttachmentDate,CreateBy) SELECT '" + UUID.randomUUID().toString() + "','Loss Assessment','" + uniqueId + "','0',FileName,'','','','" + getDateTime() + "','" + userId + "' FROM TempVideo WHERE Type ='NewCCEForm' ");
            db.execSQL("UPDATE NEWCCEForm  SET IsSubmitted='1',Latitude='"+latitude+"', Longitude='"+longitude+"',Accuracy='"+accuracy+"' WHERE AndroidUniqueId = '" + uniqueId + "'");
            db.execSQL("DELETE FROM NEWCCEFormTemp");
            db.execSQL("DELETE FROM TempVideo WHERE Type ='NewCCEForm' ");
            result = "success";
            return result;
        } catch (Exception e) {
            //e.printStackTrace();
    ...
    //<editor-fold desc="Code to Insert Data in New CCE Form Temp Table">
    public String Insert_NEWCCEFormTemp(String uniqueId, String swCornerLatitude, String swCornerLongitude, String swCornerAccuracy, String isMixedCrop, String mixedCropName, String rowsUnderStudy, String generalCropCondition, String anyDamage, String weedInPlot, String cropConditionCompare, String plotSizeId, String plantCount, String plantHeight, String squareCount, String flowerCount, String ballCount, String ballPicked,String weightTypeId, String weightType, String weightOfCotton, String expectedYeild, String comments,String experimentWeight) {
        try {
            int existCount;

            selectQuery = "SELECT AndroidUniqueId FROM NEWCCEForm WHERE AndroidUniqueId ='" + uniqueId + "'";
            cursor = db.rawQuery(selectQuery, null);
            existCount = cursor.getCount();
            cursor.close();

            if (existCount <= 0)
                db.execSQL("INSERT INTO NEWCCEForm(AndroidUniqueId,SeasonId, SeasonName,CCEType,CropId,CropName,PickingType,CropSurveyFormId,CCEMSurveyFormId, StateId, StateName, DistrictId, DistrictName, BlockId, BlockName, RevenueCircleId,RevenueCircleName, PanchayatId, PanchayatName, VillageId, VillageName, FarmerName, MobileNo,Irrigation,IrrigationSourceId, IrrigationSource,SeedCompanyName,CropVarietyId, CropVariety,SowingArea,KhasraSurveyCCEPlotNo,SurveyDate) SELECT AndroidUniqueId,SeasonId, SeasonName,CCEType,CropId,CropName,PickingType,CropSurveyFormId,CCEMSurveyFormId, StateId, StateName, DistrictId, DistrictName, BlockId, BlockName, RevenueCircleId,RevenueCircleName, PanchayatId, PanchayatName, VillageId, VillageName, FarmerName, MobileNo,Irrigation,IrrigationSourceId, IrrigationSource,SeedCompanyName,CropVarietyId, CropVariety,SowingArea,KhasraSurveyCCEPlotNo,SurveyDate FROM NEWCCEFormTemp  WHERE AndroidUniqueId = '" + uniqueId + "'");

            db.execSQL("UPDATE NEWCCEForm  SET SWCornerLatitude = '" + swCornerLatitude + "', SWCornerLongitude= '" + swCornerLongitude + "', SWCornerAccuracy='" + swCornerAccuracy + "', IsMixedCrop='" + isMixedCrop + "', MixedCropName='" + mixedCropName + "',RowsUnderStudy='" + rowsUnderStudy + "', GeneralCropCondition='" + generalCropCondition + "', AnyDamage='" + anyDamage + "', WeedInPlot='" + weedInPlot + "', CropConditionCompare='" + cropConditionCompare + "',PlotSizeId='" + plotSizeId + "', PlantCount='" + plantCount + "', PlantHeight='" + plantHeight + "', SquareCount='" + squareCount + "',FlowerCount='" + flowerCount + "', BallCount='" + ballCount + "', BallPicked='" + ballPicked + "',WeightTypeId='"+weightTypeId+"',WeightType='" + weightType + "', WeightOfCotton='" + weightOfCotton + "',ExpectedYeild='" + expectedYeild + "',Comments='" + comments + "',IsSubmitted='0',ExperimentWeight='"+experimentWeight+"' WHERE AndroidUniqueId = '" + uniqueId + "'");
    ...
    //<editor-fold desc="Code to check if data exists in NEW CCE Table">
    public boolean isTemporaryNewCCEDataAvailable() {
        boolean isAvailable = true;

        int existCount;

        selectQuery = "SELECT AndroidUniqueId FROM NEWCCEForm WHERE IsSubmitted='0'";
        cursor = db.rawQuery(selectQuery, null);
        existCount = cursor.getCount();
        cursor.close();
    ...
    //<editor-fold desc="Method to Get NEW CCE Temp data for Display by UniqueId">
    public ArrayList<HashMap<String, String>> getDataForNEWCCEFormTemp() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();

        selectQuery = "SELECT AndroidUniqueId,SeasonId,SeasonName,CCEType,CropId,CropName,PickingType,CropSurveyFormId,CCEMSurveyFormId,SurveyDate,StateId,SWCornerLatitude,SWCornerLongitude,SWCornerAccuracy,IsMixedCrop, MixedCropName,RowsUnderStudy,GeneralCropCondition,AnyDamage,WeedInPlot,CropConditionCompare,PlotSizeId ,PlantCount,PlantHeight,SquareCount,FlowerCount,BallCount,BallPicked,WeightType,WeightOfCotton,ExpectedYeild,Comments,WeightTypeId,ExperimentWeight FROM NEWCCEForm  WHERE IsSubmitted='0'";
        ...
        while (cursor.moveToNext()) {
            ...
            map.put("SurveyDate", cursor.getString(9));
            map.put("StateId", cursor.getString(10));
            map.put("SWCornerLatitude", cursor.getString(11));
            map.put("SWCornerLongitude", cursor.getString(12));
            map.put("SWCornerAccuracy", cursor.getString(13));
            map.put("IsMixedCrop", cursor.getString(14));
            map.put("MixedCropName", cursor.getString(15));
            map.put("RowsUnderStudy", cursor.getString(16));
            map.put("GeneralCropCondition", cursor.getString(17));
            map.put("AnyDamage", cursor.getString(18));
            map.put("WeedInPlot", cursor.getString(19));
            map.put("CropConditionCompare", cursor.getString(20));
            map.put("PlotSizeId", cursor.getString(21));
            map.put("PlantCount", cursor.getString(22));
            map.put("PlantHeight", cursor.getString(23));
            map.put("SquareCount", cursor.getString(24));
            map.put("FlowerCount", cursor.getString(25));
            map.put("BallCount", cursor.getString(26));
            map.put("BallPicked", cursor.getString(27));
            map.put("WeightType", cursor.getString(28));
            map.put("WeightOfCotton", cursor.getString(29));
            map.put("ExpectedYeild", cursor.getString(30));
            map.put("Comments", cursor.getString(31));
            map.put("WeightTypeId", cursor.getString(32));
            map.put("ExperimentWeight", cursor.getString(33));
            list.add(map);
        }
        cursor.close();
        return list;
    ...
    //<editor-fold desc="Code to delete File details from CCEFormTempDocument table by unique Id">
    public String DeleteNewCCEFormTempDocument(String uniqueId) {
        result = "fail";
        db.execSQL("DELETE FROM NewCCEFormTempDocument WHERE UniqueId ='" + uniqueId + "' ");
        result = "success";
        return result;
    }
    //</editor-fold>

    //<editor-fold desc="Method to Get Summary Data for New CCE Form">
    public ArrayList<HashMap<String, String>> getNewCCESumaryData() {
        ArrayList<HashMap<String, String>> list = new ArrayList<HashMap<String, String>>();

        selectQuery = "SELECT DISTINCT AndroidUniqueId,SeasonName, CropName, FarmerName, MobileNo, PickingType, SurveyDate, KhasraSurveyCCEPlotNo FROM CCEMForm frm, SeasonMaster sm, Crop cr WHERE IsSubmitted='1'  ORDER BY frm.SurveyDate ";
        cursor = db.rawQuery(selectQuery, null);
        while (cursor.moveToNext()) {
            map = new HashMap<String, String>();
            map.put("UniqueId", cursor.getString(0));
            ...
            map.put("FarmerName", cursor.getString(3));
            map.put("MobileNo", cursor.getString(4));
            map.put("PickingType", cursor.getString(5));
            map.put("SurveyDate", cursor.getString(6));
            map.put("CCEPlotKhasraNo", cursor.getString(7));
            list.add(map);
        }
